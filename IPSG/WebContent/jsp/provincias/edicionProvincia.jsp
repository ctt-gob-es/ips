...
<html>
    ...
    <h1 class="pae-title">	<spring:message code="field.provincia.modificacion.titulo"/> </h1>
...
<form:form commandName="modificarProvinciasForm" action="/IPSG/spring/modificarProvincia" id="formPadre" method="post">
		...
		<fieldset>
			...
			<div class="pae-layout__item pae-u-4/12 pae-u-2/12-lap pae-u-1/1-palm pd-top-1_7">
				<div class="pae-form__cell">
					...
					<form:input type="text" path="descripcion" maxlength="50" class="pae-form__input"/>
				</div>
			</div>
			<div class="pae-layout__item pae-u-2/12 pae-u-2/12-lap pae-u-1/1-palm pd-top-3_7">
				<div class="pae-form__cell">
					<c:choose>
					    <c:when test="${modificarProvinciasForm.visibilidad == true }">
