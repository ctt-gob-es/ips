...
<h1 class="pae-title"> <spring:message code="field.entidadFinanciera.titulo.modificarEntidadFinanciera"/> </h1>
	
<!-- <div style="margin-left:1em; margin-right: 1em;float: left;width: 99%;"> -->

<form:form commandName="modificarEntidadFinancieraForm" action="/IPSG/spring/modificarEntidadFinanciera" id="formPadre" method="post">
	<jsp:useBean id="entidadFinanciera" scope="request" class="es.map.ipsg.bean.EntidadFinancieraBean" />
		<form:hidden path="actualizada"/>
...
<div class="pae-layout">
	<div class="pae-layout__item pae-u-2/12 pae-u-2/12-lap pae-u-1/1-palm pd-top-1_7">
		<div class="pae-form__cell">
			...
			<form:input type="text" path="id" class="pae-form__input pae-box--transparent" property="id" readonly="true"/>
		</div>
	</div>	
...
<div class="filaBtn">
		<div class="pae-box-buttons pd-right-1">
			<input type="submit" value="Modificar" name="accion" class="pae-buttons pae-buttons--default pae-buttons--default-modal pae-buttons--medium"/>
