...
<form:form commandName="crearProvinciasExamenForm" action="/IPSG/spring/crearProvinciaExamen" id="formPadre" method="post">

	<form:hidden path="estado" styleClass="input_texto" styleId="estado" value="A"/>
	...
	<fieldset id="formulario">
		<div class="pae-layout">
			...
			<div class="pae-form__cell">
				...
				<form:input type="text" path="codigo" class="pae-form__input" styleId="codigo" maxlength="2"/>
			</div>
			</div>
			...
			<div class="pae-form__cell">
				...
				<form:input type="text" path="descripcion" class="pae-form__input" maxlength="50" styleClass="text_1"/>
			</div>
			</div>	
