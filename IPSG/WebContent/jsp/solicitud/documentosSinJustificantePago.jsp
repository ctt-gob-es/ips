...
<div class="pae-title"><spring:message code="field.documento.documentosPago"/></div>
<div class="pae-title"><spring:message code="field.documento.noExistenDocumentos"/></div>
