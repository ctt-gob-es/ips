...
<form:form modelAttribute="discapacidadForm" action="/IPSG/spring/modificarDiscapacidad" method="post">
	     ...
	     <div class="pae-layout__item pae-u-1/12 pae-u-2/12-lap pae-u-1/1-palm pd-top-1_7">
		   <div class="pae-form__cell">
				<span class="pae-form__label pae-form__span-label">
					<spring:message code="field.discapacidad.id"/>
				</span>
				<logic:present name="discapacidad" scope="request">
				<form:input path="id" name="discapacidad" class="pae-form__input pae-box--transparent" maxlength="10" readonly="true"/>
				</logic:present>
				<logic:notPresent name="discapacidad" scope="request">
		...
		<div class="pae-layout__item pae-u-1/12 pae-u-2/12-lap pae-u-1/1-palm search_btn2">
	     ...
	     <div class="pae-layout__item pae-u-4/12 pae-u-2/12-lap pae-u-1/1-palm pd-top-1_7">
		   <div class="pae-form__cell">
			...
			<logic:present name="discapacidad" scope="request">
				<form:input path="descripcion" name="discapacidad" class="pae-form__input" maxlength="100"/>
			</logic:present>
			<logic:notPresent name="discapacidad" scope="request">
		...
		<div class="pae-layout__item pae-u-2/12 pae-u-2/12-lap pae-u-1/1-palm pd-top-3_7">
			...
			<logic:present name="discapacidad" scope="request">
		     <div class="pae-layout__item pae-u-2/12 pae-u-2/12-lap pae-u-1/1-palm pd-top-check">
			   <div class="pae-form__cell">
			   		<c:choose>
					    <c:when test="${discapacidad.visibilidad == true }">
	...
	<div class="clear"></div> 
 		...
 		<div class="filaBtn">
			<div class="pae-box-buttons">
				...
				<input type="button" value="Cancelar " name="submit" onclick="volver('../spring/buscarDiscapacidad')" class="pae-buttons pae-buttons--default pae-buttons--default-modal pae-buttons--medium pae-buttons--download outline mg-left-1"/>
			</div>
		</div>
