...
function cancelar(){
	window.location.href = "../spring/buscarCuerposEscala";
}
...
<form:form modelAttribute="cuerpoEscalaForm" action="/IPSG/spring/altaCuerposEscala" method="post">

<logic:present name="cuerposEscala" scope="request"><form:hidden path="id" name="cuerposEscala" /></logic:present>
