...
function cancelar(){
	window.location.href = "../spring/buscarOtrosTitulos";
}
...
<form:form modelAttribute="otrosTitulosForm" action="/IPSG/spring/altaOtrosTitulos" method="post">

<logic:present name="otrosTitulos" scope="request"><form:hidden path="id" name="otrosTitulos" /></logic:present>
