...
import es.map.ipsg.action.CertificadoSpring;
 ...
 */
public class CertificadoTest extends AbstractSpringCommonTestCaseIPSG {
	...
	protected void setUp() throws Exception {
		...
		mapping = springMappingManager.getMapping("/springPub/cert/certificadoSpring", CertificadoSpring.class);
		
		//Se cargan los managers
		certificadoSpring = new CertificadoSpring();
		certificadoSpring.setUsuarioManager((UsuarioManager) getBean("usuarioManager"));
	...
	public void testSearch() {
		...
		try {
			...
			CertificadoForm formulario = new CertificadoForm();
			formulario.setJ_username("admin");
			formulario.setPasswordField("password");
