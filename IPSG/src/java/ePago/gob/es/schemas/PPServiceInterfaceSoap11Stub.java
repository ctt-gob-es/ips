...
public class PPServiceInterfaceSoap11Stub extends org.apache.axis.client.Stub implements ePago.gob.es.schemas.PPServiceInterface {
 ...
 try {        java.lang.Object _resp = _call.invoke(new java.lang.Object[] {datosNRCIn, new java.lang.Integer(idOrganismo)});
			 ...
			 try{
				 ...
				 logger.info("CONSULTA Verificación Pago - request: " + llamada);
			 } catch (Exception e) {
				 logger.error("CONSULTA Verificación Pago: Error mostrando request: ",e);
			 }
			 ...
			 try {
				 ...
				 logger.info("CONSULTA Verificación Pago - response: " + respuesta);
			 } catch (Exception e) {
				 logger.error("CONSULTA Verificación Pago: Error mostrando response: ",e);
			 }
