...
public class Tipo implements java.io.Serializable {
    ...
    public static final java.lang.String _value2 = "Tasas";
    public static final Tipo value1 = new Tipo(_value1);
    public static final Tipo value2 = new Tipo(_value2);
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.agenciatributaria.es/peticion", ">Tipo"));
    }
    /**
