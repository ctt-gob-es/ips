...
public class Tipo implements java.io.Serializable {
    ...
    public static final java.lang.String _Tasas = "Tasas";
    public static final Tipo Tasas = new Tipo(_Tasas);
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.agenciatributaria.es/respuesta", ">Tipo"));
    }
    /**
