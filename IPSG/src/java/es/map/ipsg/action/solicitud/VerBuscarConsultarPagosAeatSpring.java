...
/**
 * El Class VerBuscarConsultarPagosAeatSpring.
 */
public class VerBuscarConsultarPagosAeatSpring extends AbstractSpring {
	...
	/** La constante logger. */
	private static final Logger logger = Logger.getLogger(VerBuscarConsultarPagosAeatSpring.class);
	
	/**
	 * Crea una nueva ver buscar consultar pagos aeat spring.
	 */
	public VerBuscarConsultarPagosAeatSpring() {
		try {
				setUsuarioManager((UsuarioManager) getBean("usuarioManager"));				
			} catch (Exception e) {
				logger.error(" Error VerBuscarConsultarPagosAeatSpring : ",e);
		}
	}
	...
	try{	
		...
		ConsultarRegistrosPagoAeatForm formulario;
		formulario = (ConsultarRegistrosPagoAeatForm) form;
		...
		logger.error(" Error VerBuscarConsultarPagosAeatSpring  - doExecute: ",eGenerico);
	...
	private String recuperarUsuario() {
		...
		try{
			...
			logger.error(" Error VerBuscarConsultarPagosAeatSpring  - error recuperar usuariosesion: "+ sUsernameLogin ,e);
