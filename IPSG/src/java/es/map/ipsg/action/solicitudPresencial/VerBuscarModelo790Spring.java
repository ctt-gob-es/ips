...
/**
 * El Class VerBuscarModelo790Spring.
 *
 * @author amartinl
 */
public class VerBuscarModelo790Spring extends AbstractSpring {
	...
	/** La constante logger. */
	private static final Logger logger = Logger.getLogger(VerBuscarModelo790Spring.class);
	
	/**
	 * Crea una nueva ver buscar modelo 790 spring.
	 */
	public VerBuscarModelo790Spring() {
		try {
	...
	try{	
		...
		logger.error("Error VerBuscarModelo790Spring - doExecute",eGenerico);
