...
public class DocumentoType  implements java.io.Serializable {
    ...
    /** el bl documento. */
    private java.lang.String blDocumento;

    /** el bl firma. */
    private java.lang.String blFirma;

    /** el cd firmado. */
    private java.lang.String cdFirmado;
     ...
     * @param blDocumento el bl documento
     * @param blFirma el bl firma
     * @param cdFirmado el cd firmado
    ...
    public DocumentoType(
           ...
           java.lang.String blDocumento,
           java.lang.String blFirma,
           java.lang.String cdFirmado,
           ...
           this.blFirma = blFirma;
           this.cdFirmado = cdFirmado;
    ...
    /**
     * Gets the dsNombre value for this DocumentoType.
     * 
     * @return dsNombre
     */
    ...
    /**
     * Sets the dsNombre value for this DocumentoType.
     *
    ...
    /**
     * Gets the cdValidez value for this DocumentoType.
     * 
     * @return cdValidez
     */
    ...
    /**
     * Sets the cdValidez value for this DocumentoType.
     *
    ...
    /**
     * Gets the cdTipo value for this DocumentoType.
     * 
     * @return cdTipo
     */
    ...
    /**
     * Sets the cdTipo value for this DocumentoType.
     *
    ...
    /**
     * Gets the blDocumento value for this DocumentoType.
     * 
     * @return blDocumento
     */
    public java.lang.String getBlDocumento() {
        return blDocumento;
    }


    /**
     * Sets the blDocumento value for this DocumentoType.
     *
     * @param blDocumento el nuevo bl documento
     */
    public void setBlDocumento(java.lang.String blDocumento) {
        this.blDocumento = blDocumento;
    }


    /**
     * Gets the blFirma value for this DocumentoType.
     * 
     * @return blFirma
     */
    public java.lang.String getBlFirma() {
        return blFirma;
    }


    /**
     * Sets the blFirma value for this DocumentoType.
     *
     * @param blFirma el nuevo bl firma
     */
    public void setBlFirma(java.lang.String blFirma) {
        this.blFirma = blFirma;
    }


    /**
     * Gets the cdFirmado value for this DocumentoType.
     * 
     * @return cdFirmado
     */
    public java.lang.String getCdFirmado() {
        return cdFirmado;
    }


    /**
     * Sets the cdFirmado value for this DocumentoType.
     *
     * @param cdFirmado el nuevo cd firmado
     */
    public void setCdFirmado(java.lang.String cdFirmado) {
        this.cdFirmado = cdFirmado;
    }


    /**
     * Gets the blPKCertificado value for this DocumentoType.
     * 
    ...
    /**
     * Sets the blPKCertificado value for this DocumentoType.
     *
    ...
    /**
     * Gets the blTimeStamp value for this DocumentoType.
     * 
     * @return blTimeStamp
     */
    ...
    /**
     * Sets the blTimeStamp value for this DocumentoType.
     *
    ...
    /**
     * Gets the blValidacionOCSP value for this DocumentoType.
     * 
    ...
    /**
     * Sets the blValidacionOCSP value for this DocumentoType.
     *
    ...
    /**
     * Gets the blHash value for this DocumentoType.
     * 
     * @return blHash
     */
    ...
    /**
     * Sets the blHash value for this DocumentoType.
     *
    ...
    /**
     * Gets the dsTipoMIME value for this DocumentoType.
     * 
     * @return dsTipoMIME
     */
    ...
    /**
     * Sets the dsTipoMIME value for this DocumentoType.
     *
    ...
    /**
     * Gets the tlObservaciones value for this DocumentoType.
     * 
    ...
    /**
     * Sets the tlObservaciones value for this DocumentoType.
     *
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        ...
        _equals = true && 
            ...
            ((this.blDocumento==null && other.getBlDocumento()==null) || 
             (this.blDocumento!=null &&
              this.blDocumento.equals(other.getBlDocumento()))) &&
            ((this.blFirma==null && other.getBlFirma()==null) || 
             (this.blFirma!=null &&
              this.blFirma.equals(other.getBlFirma()))) &&
            ((this.cdFirmado==null && other.getCdFirmado()==null) || 
             (this.cdFirmado!=null &&
              this.cdFirmado.equals(other.getCdFirmado()))) &&
    ...
    public synchronized int hashCode() {
        ...
        if (getBlDocumento() != null) {
            _hashCode += getBlDocumento().hashCode();
        }
        if (getBlFirma() != null) {
            _hashCode += getBlFirma().hashCode();
        }
        if (getCdFirmado() != null) {
            _hashCode += getCdFirmado().hashCode();
        }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://type.ws2.rec2are.map.es", "DocumentoType"));
        ...
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("blDocumento");
        elemField.setXmlName(new javax.xml.namespace.QName("", "blDocumento"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "string"));
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("blFirma");
        elemField.setXmlName(new javax.xml.namespace.QName("", "blFirma"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "string"));
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("cdFirmado");
        elemField.setXmlName(new javax.xml.namespace.QName("", "cdFirmado"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "string"));
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
