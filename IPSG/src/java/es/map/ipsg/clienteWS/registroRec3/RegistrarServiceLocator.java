 ...
 */
public class RegistrarServiceLocator extends org.apache.axis.client.Service implements es.map.ipsg.clienteWS.registroRec3.RegistrarService {
    ...
    /* (non-Javadoc)
     * @see es.map.ipsg.clienteWS.registroRec3.RegistrarService#getRegistrarServiceAddress()
     */
    ...
    /* (non-Javadoc)
     * @see es.map.ipsg.clienteWS.registroRec3.RegistrarService#getRegistrarService()
     */
    public es.map.ipsg.clienteWS.registroRec3.RegistrarElectronicosService getRegistrarService() throws javax.xml.rpc.ServiceException {
    ...
    /* (non-Javadoc)
     * @see es.map.ipsg.clienteWS.registroRec3.RegistrarService#getRegistrarService(java.net.URL)
     */
    public es.map.ipsg.clienteWS.registroRec3.RegistrarElectronicosService getRegistrarService(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
        	es.map.ipsg.clienteWS.registroRec3.RegistrarServiceSoapBindingStub _stub = new es.map.ipsg.clienteWS.registroRec3.RegistrarServiceSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (es.map.ipsg.clienteWS.registroRec3.RegistrarElectronicosService.class.isAssignableFrom(serviceEndpointInterface)) {
            	es.map.ipsg.clienteWS.registroRec3.RegistrarServiceSoapBindingStub _stub = new es.map.ipsg.clienteWS.registroRec3.RegistrarServiceSoapBindingStub(new java.net.URL(RegistrarService_address), this);
                _stub.setPortName(getRegistrarServiceWSDDServiceName());
                return _stub;
            }
        }
