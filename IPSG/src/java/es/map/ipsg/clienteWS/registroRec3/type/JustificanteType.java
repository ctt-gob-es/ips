...
public class JustificanteType  implements java.io.Serializable {
    ...
    /** el interesados. */
    private es.map.ipsg.clienteWS.registroRec3.type.InteresadoJustificanteType[] interesados;

    /** el documentos. */
    private es.map.ipsg.clienteWS.registroRec3.type.DocumentoJustificanteType[] documentos;
    ...
    /** el respuesta. */
    private es.map.ipsg.clienteWS.registroRec3.type.RespuestaType respuesta;
    ...
    public JustificanteType(
           ...
           es.map.ipsg.clienteWS.registroRec3.type.InteresadoJustificanteType[] interesados,
           es.map.ipsg.clienteWS.registroRec3.type.DocumentoJustificanteType[] documentos,
           ...
           es.map.ipsg.clienteWS.registroRec3.type.RespuestaType respuesta) {
     ...
     * @return interesados
     */
    public es.map.ipsg.clienteWS.registroRec3.type.InteresadoJustificanteType[] getInteresados() {
        return interesados;
    }
     ...
     */
    public void setInteresados(es.map.ipsg.clienteWS.registroRec3.type.InteresadoJustificanteType[] interesados) {
        this.interesados = interesados;
    }
     ...
     * @return documentos
     */
    public es.map.ipsg.clienteWS.registroRec3.type.DocumentoJustificanteType[] getDocumentos() {
        return documentos;
    }
     ...
     */
    public void setDocumentos(es.map.ipsg.clienteWS.registroRec3.type.DocumentoJustificanteType[] documentos) {
        this.documentos = documentos;
    }
     ...
     * @return respuesta
     */
    public es.map.ipsg.clienteWS.registroRec3.type.RespuestaType getRespuesta() {
        return respuesta;
    }
     ...
     */
    public void setRespuesta(es.map.ipsg.clienteWS.registroRec3.type.RespuestaType respuesta) {
        this.respuesta = respuesta;
    }
