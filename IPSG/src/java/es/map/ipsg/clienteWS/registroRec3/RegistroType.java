...
public class RegistroType  implements java.io.Serializable {
    ...
    /** el interesados. */
    private es.map.ipsg.clienteWS.registroRec3.type.InteresadoType[] interesados;

    /** el documentos. */
    private es.map.ipsg.clienteWS.registroRec3.type.DocumentoType[] documentos;
    ...
    public RegistroType(
           ...
           es.map.ipsg.clienteWS.registroRec3.type.InteresadoType[] interesados,
           es.map.ipsg.clienteWS.registroRec3.type.DocumentoType[] documentos,
     ...
     * @return interesados
     */
    public es.map.ipsg.clienteWS.registroRec3.type.InteresadoType[] getInteresados() {
        return interesados;
    }
     ...
     */
    public void setInteresados(es.map.ipsg.clienteWS.registroRec3.type.InteresadoType[] interesados) {
        this.interesados = interesados;
    }
     ...
     * @return documentos
     */
    public es.map.ipsg.clienteWS.registroRec3.type.DocumentoType[] getDocumentos() {
        return documentos;
    }
     ...
     */
    public void setDocumentos(es.map.ipsg.clienteWS.registroRec3.type.DocumentoType[] documentos) {
        this.documentos = documentos;
    }
