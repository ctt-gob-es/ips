...
/**
 * El Class CambiarContrasenaUsuariosForm.
 */
public class CambiarContrasenaUsuariosForm extends SpringForm {
	...
	/** La constante logger. */
	private static final Logger logger = Logger.getLogger(CambiarContrasenaUsuariosForm.class);
