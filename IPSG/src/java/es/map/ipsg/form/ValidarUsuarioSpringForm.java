...
/**
 * El Class ValidarUsuarioSpringForm.
 */
public class ValidarUsuarioSpringForm extends SpringForm {
	...
	/** La constante logger. */
	private static final Logger logger = Logger.getLogger(ValidarUsuarioSpringForm.class);
