...
public class NumeroSolicitud {
	...
	public String obtenerNumeroJustificanteEJB(){
		...
		try{
			...
			logger.error("Error obtenerNumeroJustificanteEJB: ",ex);
		}
	 ...
	 * @param idTasa el id tasa
	 * @param idModelo el id modelo
	 * @return el string
	 */
	public String obtenerNumeroJustificanteLocal(Integer contador, String idTasa, String idModelo){
	 ...
	 * @return el string
	 */
	public String obtenerNumeroSolicitud(Integer contador,  String modelo){
		String nSolicitud = obtenerNumeroJustificanteLocal(contador,modelo);
