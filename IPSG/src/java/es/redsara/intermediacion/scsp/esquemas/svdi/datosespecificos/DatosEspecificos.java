...
/**
 * Clase de mapeo de respuesta del Servicio de Consulta De Identidad de la DGP V3.
 * @author lgonzale
 *
 */
public class DatosEspecificos  implements java.io.Serializable {
	...
	/** el retorno. */
	private es.redsara.intermediacion.scsp.esquemas.svdi.datosespecificos.Retorno retorno;
     ...
     */
    public DatosEspecificos(
            es.redsara.intermediacion.scsp.esquemas.svdi.datosespecificos.Retorno retorno,
            java.lang.String id) {
     ...
     */
    public es.redsara.intermediacion.scsp.esquemas.svdi.datosespecificos.Retorno getRetorno() {
        return retorno;
    }
     ...
     */
    public void setRetorno(es.redsara.intermediacion.scsp.esquemas.svdi.datosespecificos.Retorno retorno) {
        this.retorno = retorno;
    }
