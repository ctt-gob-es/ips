...
public class DatosTitulacion  implements java.io.Serializable {
    ...
    /** el datos centro. */
    private es.redsara.intermediacion.scsp.esquemas.educacionnouniv.datosespecificos.DatosCentro datosCentro;

    /** el datos titulo. */
    private es.redsara.intermediacion.scsp.esquemas.educacionnouniv.datosespecificos.DatosTitulo datosTitulo;
     ...
     */
    public DatosTitulacion(
           es.redsara.intermediacion.scsp.esquemas.educacionnouniv.datosespecificos.DatosCentro datosCentro,
           es.redsara.intermediacion.scsp.esquemas.educacionnouniv.datosespecificos.DatosTitulo datosTitulo) {
     ...
     * @return datosCentro
     */
    public es.redsara.intermediacion.scsp.esquemas.educacionnouniv.datosespecificos.DatosCentro getDatosCentro() {
        return datosCentro;
    }
     ...
     */
    public void setDatosCentro(es.redsara.intermediacion.scsp.esquemas.educacionnouniv.datosespecificos.DatosCentro datosCentro) {
        this.datosCentro = datosCentro;
    }
     ...
     * @return datosTitulo
     */
    public es.redsara.intermediacion.scsp.esquemas.educacionnouniv.datosespecificos.DatosTitulo getDatosTitulo() {
        return datosTitulo;
    }
     ...
     *
     * @param datosTitulo el nuevo datos titulo
     */
    public void setDatosTitulo(es.redsara.intermediacion.scsp.esquemas.educacionnouniv.datosespecificos.DatosTitulo datosTitulo) {
        this.datosTitulo = datosTitulo;
    }
    ...
    static {
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("http://intermediacion.redsara.es/scsp/esquemas/datosespecificos", ">DatosTitulo"));
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
    }
