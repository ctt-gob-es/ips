/**
 * SEPEInscritoDemandanteEmpleoFechaConcretaBindingStub.java
 *
 ...
 */
public class ScspwsSoap11Stub extends org.apache.axis.client.Stub implements es.redsara.intermediacion.scsp.esquemas.sepe.ws.Scspws {
    ...
    private static void _initOperationDesc1(){
        ...
        oper.setReturnClass(es.redsara.intermediacion.scsp.esquemas.sepe.ws.respuesta.Respuesta.class);
...
private void addBindings0() {
    ...
    cachedDeserFactories.add(org.apache.axis.encoding.ser.BaseDeserializerFactory.createFactory(org.apache.axis.encoding.ser.SimpleDeserializerFactory.class, cls, qName));
            ...
            cachedSerQNames.add(qName);
            cls = es.redsara.intermediacion.scsp.esquemas.sepe.datosespecificos.Estado.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);
            ...
            cachedSerQNames.add(qName);
            cls = es.redsara.intermediacion.scsp.esquemas.sepe.datosespecificos.Consulta.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);
            ...
            cachedSerQNames.add(qName);
            cls = es.redsara.intermediacion.scsp.esquemas.sepe.datosespecificos.DatosEspecificos.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);

            qName = new javax.xml.namespace.QName("http://intermediacion.redsara.es/scsp/esquemas/datosespecificos", "DemandanteEmpleo");
            cachedSerQNames.add(qName);
            cls = es.redsara.intermediacion.scsp.esquemas.sepe.datosespecificos.DemandanteEmpleo.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);

            qName = new javax.xml.namespace.QName("http://intermediacion.redsara.es/scsp/esquemas/datosespecificos", "DiasInscritos");
            cachedSerQNames.add(qName);
            cls = int.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(org.apache.axis.encoding.ser.BaseSerializerFactory.createFactory(org.apache.axis.encoding.ser.SimpleSerializerFactory.class, cls, qName));
            ...
            qName = new javax.xml.namespace.QName("http://intermediacion.redsara.es/scsp/esquemas/datosespecificos", "Inscrito");
            cachedSerQNames.add(qName);
            cls = es.redsara.intermediacion.scsp.esquemas.sepe.datosespecificos.Inscrito.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(enumsf);
            cachedDeserFactories.add(enumdf);

            qName = new javax.xml.namespace.QName("http://intermediacion.redsara.es/scsp/esquemas/datosespecificos", "LargaDuracion");
            cachedSerQNames.add(qName);
            cls = es.redsara.intermediacion.scsp.esquemas.sepe.datosespecificos.LargaDuracion.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);
            ...
            cachedSerQNames.add(qName);
            cls = es.redsara.intermediacion.scsp.esquemas.sepe.datosespecificos.Retorno.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);
            ...
            cachedSerQNames.add(qName);
            cls = es.redsara.intermediacion.scsp.esquemas.sepe.ws.respuesta.TransmisionesTransmisionDatos.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);
            ...
            cachedSerQNames.add(qName);
            cls = es.redsara.intermediacion.scsp.esquemas.sepe.ws.respuesta.Respuesta.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);
            ...
            cachedSerQNames.add(qName);
            cls = es.redsara.intermediacion.scsp.esquemas.sepe.ws.respuesta.Transmisiones.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);
...
try {        java.lang.Object _resp = _call.invoke(new java.lang.Object[] {peticionSincrona});
	...
	// Log de la peticion soap
	 try {
		 ...
		 logger.info("CONSULTA DATOS DESEMPLEO - request: " + llamada);
	 } catch (Exception e) {
		 logger.error("CONSULTA DATOS DESEMPLEO: Error mostrando request: ",e);
	 }
	 ...
	 try {
		 ...
		 logger.info("CONSULTA DATOS DESEMPLEO - response: " + respuesta);
	 } catch (Exception e) {
		 logger.error("CONSULTA DATOS DESEMPLEO: Error mostrando response: ",e);
	 }
    ...
    if (_resp instanceof java.rmi.RemoteException) {
        ...
        try {
            return (es.redsara.intermediacion.scsp.esquemas.sepe.ws.respuesta.Respuesta) _resp;
        } catch (java.lang.Exception _exception) {
            return (es.redsara.intermediacion.scsp.esquemas.sepe.ws.respuesta.Respuesta) org.apache.axis.utils.JavaUtils.convert(_resp, es.redsara.intermediacion.scsp.esquemas.sepe.ws.respuesta.Respuesta.class);
        }
    }
...
try {        java.lang.Object _resp = _call.invoke(new java.lang.Object[] {peticionAsincrona});
	...
	//Log de la peticion soap
	 try {
		 String llamada = _call.getMessageContext().getRequestMessage().getSOAPPart().getEnvelope().getBody().toString();
		 logger.info("CONSULTA DATOS DESEMPLEO DIAS ASINCRONA - request: " + llamada);
	 } catch (Exception e) {
		 logger.error("CONSULTA DATOS DESEMPLEO DIAS ASINCRONA: Error mostrando request: ",e);
	 }
	 // Log de la respuesta soap
	 try {
		 String respuesta = _call.getMessageContext().getResponseMessage().getSOAPPart().getEnvelope().getBody().toString();
		 logger.info("CONSULTA DATOS DESEMPLEO DIAS ASINCRONA - response: " + respuesta);
	 } catch (Exception e) {
		 logger.error("CONSULTA DATOS DESEMPLEO DIAS ASINCRONA: Error mostrando response: ",e);
	 }
...
//Log de la peticion soap
	 try {
		 String llamada = _call.getMessageContext().getRequestMessage().getSOAPPart().getEnvelope().getBody().toString();
		 logger.info("RESPUESTA DATOS DESEMPLEO DIAS ASINCRONA - request: " + llamada);
	 } catch (Exception e) {
		 logger.error("RESPUESTA DATOS DESEMPLEO DIAS ASINCRONA: Error mostrando request: ",e);
	 }
	 // Log de la respuesta soap
	 try {
		 String respuesta = _call.getMessageContext().getResponseMessage().getSOAPPart().getEnvelope().getBody().toString();
		 logger.info("RESPUESTA DATOS DESEMPLEO DIAS ASINCRONA - response: " + respuesta);
	 } catch (Exception e) {
		 logger.error("RESPUESTA DATOS DESEMPLEO DIAS ASINCRONA: Error mostrando response: ",e);
	 }
