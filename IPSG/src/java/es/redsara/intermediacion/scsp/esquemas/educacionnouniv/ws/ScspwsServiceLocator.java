 ...
 */
public class ScspwsServiceLocator extends org.apache.axis.client.Service implements es.redsara.intermediacion.scsp.esquemas.educacionnouniv.ws.ScspwsService {
    ...
    /* (non-Javadoc)
     * @see es.redsara.intermediacion.scsp.esquemas.educacionnouniv.ws.ScspwsService#getscspwsSoap11Address()
     */
    ...
    /* (non-Javadoc)
     * @see es.redsara.intermediacion.scsp.esquemas.educacionnouniv.ws.ScspwsService#getscspwsSoap11()
     */
    ...
    /* (non-Javadoc)
     * @see es.redsara.intermediacion.scsp.esquemas.educacionnouniv.ws.ScspwsService#getscspwsSoap11(java.net.URL)
     */
    public es.redsara.intermediacion.scsp.esquemas.educacionnouniv.ws.Scspws getscspwsSoap11(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            es.redsara.intermediacion.scsp.esquemas.educacionnouniv.ws.ScspwsSoap11Stub _stub = new es.redsara.intermediacion.scsp.esquemas.educacionnouniv.ws.ScspwsSoap11Stub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (es.redsara.intermediacion.scsp.esquemas.educacionnouniv.ws.Scspws.class.isAssignableFrom(serviceEndpointInterface)) {
                es.redsara.intermediacion.scsp.esquemas.educacionnouniv.ws.ScspwsSoap11Stub _stub = new es.redsara.intermediacion.scsp.esquemas.educacionnouniv.ws.ScspwsSoap11Stub(new java.net.URL(scspwsSoap11_address), this);
                _stub.setPortName(getscspwsSoap11WSDDServiceName());
                return _stub;
            }
        }
