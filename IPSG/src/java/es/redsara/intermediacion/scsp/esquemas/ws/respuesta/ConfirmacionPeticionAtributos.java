/**
 * ConfirmacionPeticionAtributos.java
 *
...
/**
 * El Class ConfirmacionPeticionAtributos.
 */
public class ConfirmacionPeticionAtributos  implements java.io.Serializable {
    ...
    /** el estado. */
    private es.redsara.intermediacion.scsp.esquemas.ws.respuesta.Estado estado;

    /** el codigo certificado. */
    private java.lang.String codigoCertificado;

    /**
     * Crea una nueva confirmacion peticion atributos.
     */
    public ConfirmacionPeticionAtributos() {
    }
    ...
    public ConfirmacionPeticionAtributos(
           ...
           es.redsara.intermediacion.scsp.esquemas.ws.respuesta.Estado estado,
    ...
    /**
     * Gets the idPeticion value for this ConfirmacionPeticionAtributos.
     * 
     * @return idPeticion
     */
    ...
    /**
     * Sets the idPeticion value for this ConfirmacionPeticionAtributos.
     *
    ...
    /**
     * Gets the numElementos value for this ConfirmacionPeticionAtributos.
     * 
     * @return numElementos
     */
    ...
    /**
     * Sets the numElementos value for this ConfirmacionPeticionAtributos.
     *
    ...
    /**
     * Gets the timeStamp value for this ConfirmacionPeticionAtributos.
     * 
     * @return timeStamp
     */
    ...
    /**
     * Sets the timeStamp value for this ConfirmacionPeticionAtributos.
     *
    ...
    /**
     * Gets the estado value for this ConfirmacionPeticionAtributos.
     * 
     * @return estado
     */
    public es.redsara.intermediacion.scsp.esquemas.ws.respuesta.Estado getEstado() {
        return estado;
    }


    /**
     * Sets the estado value for this ConfirmacionPeticionAtributos.
     *
     * @param estado el nuevo estado
     */
    public void setEstado(es.redsara.intermediacion.scsp.esquemas.ws.respuesta.Estado estado) {
        this.estado = estado;
    }


    /**
     * Gets the codigoCertificado value for this ConfirmacionPeticionAtributos.
     * 
    ...
    /**
     * Sets the codigoCertificado value for this ConfirmacionPeticionAtributos.
     *
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof ConfirmacionPeticionAtributos)) return false;
        ConfirmacionPeticionAtributos other = (ConfirmacionPeticionAtributos) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(ConfirmacionPeticionAtributos.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://intermediacion.redsara.es/scsp/esquemas/ws/respuesta", ">>ConfirmacionPeticion>Atributos"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("http://intermediacion.redsara.es/scsp/esquemas/ws/respuesta", "TimeStamp"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://intermediacion.redsara.es/scsp/esquemas/ws/respuesta", ">TimeStamp"));
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("estado");
        elemField.setXmlName(new javax.xml.namespace.QName("http://intermediacion.redsara.es/scsp/esquemas/ws/respuesta", "Estado"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://intermediacion.redsara.es/scsp/esquemas/ws/respuesta", ">Estado"));
