...
public class Transmisiones  implements java.io.Serializable {
    ...
    private es.redsara.intermediacion.scsp.esquemas.educacion1990noUniv.ws.respuesta.TransmisionDatos[] transmisionDatos;
     ...
     */
    public Transmisiones(
    		es.redsara.intermediacion.scsp.esquemas.educacion1990noUniv.ws.respuesta.TransmisionDatos[] transmisionDatos) {
     ...
     */
    public es.redsara.intermediacion.scsp.esquemas.educacion1990noUniv.ws.respuesta.TransmisionDatos[] getTransmisionDatos() {
        return transmisionDatos;
    }
     ...
     */
    public void setTransmisionDatos(es.redsara.intermediacion.scsp.esquemas.educacion1990noUniv.ws.respuesta.TransmisionDatos[] transmisionDatos) {
        this.transmisionDatos = transmisionDatos;
    }
     ...
     */
    public es.redsara.intermediacion.scsp.esquemas.educacion1990noUniv.ws.respuesta.TransmisionDatos getTransmisionDatos(int i) {
     ...
     */
    public void setTransmisionDatos(int i, es.redsara.intermediacion.scsp.esquemas.educacion1990noUniv.ws.respuesta.TransmisionDatos _value) {
