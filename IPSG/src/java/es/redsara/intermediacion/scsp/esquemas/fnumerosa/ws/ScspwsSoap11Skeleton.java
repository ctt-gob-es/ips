...
public class ScspwsSoap11Skeleton implements es.redsara.intermediacion.scsp.esquemas.fnumerosa.ws.Scspws, org.apache.axis.wsdl.Skeleton {
    
    /** el impl. */
    private es.redsara.intermediacion.scsp.esquemas.fnumerosa.ws.Scspws impl;
    ...
    public ScspwsSoap11Skeleton() {
        this.impl = new es.redsara.intermediacion.scsp.esquemas.fnumerosa.ws.ScspwsSoap11Impl();
    }
     ...
     * @param impl el impl
     */
    public ScspwsSoap11Skeleton(es.redsara.intermediacion.scsp.esquemas.fnumerosa.ws.Scspws impl) {
        this.impl = impl;
    }
    ...
    {
        es.redsara.intermediacion.scsp.esquemas.fnumerosa.ws.respuesta.Respuesta ret = impl.peticionSincrona(peticionSincrona);
        return ret;
    }
    ...
    {
        es.redsara.intermediacion.scsp.esquemas.fnumerosa.ws.respuesta.Respuesta ret = impl.solicitudRespuesta(solicitudRespuesta);
        return ret;
    }
