/**
 * SEPECertificadoPeriodosLocator.java
 *
...
public class ScspwsServiceLocator extends org.apache.axis.client.Service implements es.redsara.intermediacion.scsp.esquemas.victimasTerrorismo.ws.ScspwsService {
 ...
 // The WSDD service name defaults to the port name.
    ...
    public es.redsara.intermediacion.scsp.esquemas.victimasTerrorismo.ws.Scspws getscspwsSoap11() throws javax.xml.rpc.ServiceException {
        java.net.URL endpoint;
         ...
         public es.redsara.intermediacion.scsp.esquemas.victimasTerrorismo.ws.Scspws getscspwsSoap11(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
             try {
                 es.redsara.intermediacion.scsp.esquemas.victimasTerrorismo.ws.ScspwsSoap11Stub _stub = new es.redsara.intermediacion.scsp.esquemas.victimasTerrorismo.ws.ScspwsSoap11Stub(portAddress, this);
         ...
         public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
             try {
                 if (es.redsara.intermediacion.scsp.esquemas.victimasTerrorismo.ws.Scspws.class.isAssignableFrom(serviceEndpointInterface)) {
                     es.redsara.intermediacion.scsp.esquemas.victimasTerrorismo.ws.ScspwsSoap11Stub _stub = new es.redsara.intermediacion.scsp.esquemas.victimasTerrorismo.ws.ScspwsSoap11Stub(new java.net.URL(scspwsSoap11_address), this);
                     _stub.setPortName(getscspwsSoap11WSDDServiceName());
                     return _stub;
                 }
             }
