...
public class DatosEspecificos  implements java.io.Serializable {
    ...
    /** el consulta. */
    /* Solo en el mensaje de PETICION */
    private es.redsara.intermediacion.scsp.esquemas.discapacidad.datosespecificos.Consulta consulta;

    /** el retorno. */
    /* Solo en el mensaje RESPUESTA */
    private es.redsara.intermediacion.scsp.esquemas.discapacidad.datosespecificos.Retorno retorno;
     ...
     */
    public DatosEspecificos(
           es.redsara.intermediacion.scsp.esquemas.discapacidad.datosespecificos.Consulta consulta,
           es.redsara.intermediacion.scsp.esquemas.discapacidad.datosespecificos.Retorno retorno,
           java.lang.String id) {
     ...
     * 
     * @return consulta   * Solo en el mensaje de PETICION
     */
    public es.redsara.intermediacion.scsp.esquemas.discapacidad.datosespecificos.Consulta getConsulta() {
        return consulta;
    }
     ...
     * 
     * @param consulta   * Solo en el mensaje de PETICION
     */
    public void setConsulta(es.redsara.intermediacion.scsp.esquemas.discapacidad.datosespecificos.Consulta consulta) {
        this.consulta = consulta;
    }
     ...
     * 
     * @return retorno   * Solo en el mensaje RESPUESTA
     */
    public es.redsara.intermediacion.scsp.esquemas.discapacidad.datosespecificos.Retorno getRetorno() {
        return retorno;
    }
     ...
     * 
     * @param retorno   * Solo en el mensaje RESPUESTA
     */
    public void setRetorno(es.redsara.intermediacion.scsp.esquemas.discapacidad.datosespecificos.Retorno retorno) {
        this.retorno = retorno;
    }
