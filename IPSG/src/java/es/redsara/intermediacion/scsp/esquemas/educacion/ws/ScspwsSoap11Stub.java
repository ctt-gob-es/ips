...
package es.redsara.intermediacion.scsp.esquemas.educacion.ws;
 ...
 */
public class ScspwsSoap11Stub extends org.apache.axis.client.Stub implements es.redsara.intermediacion.scsp.esquemas.educacion.ws.Scspws {
    ...
    private static void _initOperationDesc1(){
        ...
        oper.setReturnClass(es.redsara.intermediacion.scsp.esquemas.educacion.ws.respuesta.Respuesta.class);
    ...
    private void addBindings0() {
            ...
            cls = es.redsara.intermediacion.scsp.esquemas.educacion.datosespecificos.RetornoDatosTitular.class;
            ...
            cachedSerClasses.add(cls);
            cachedSerFactories.add(documentsf);
            cachedDeserFactories.add(documentdf);
            */
            ...
            cachedSerQNames.add(qName);
            cls = es.redsara.intermediacion.scsp.esquemas.educacion.datosespecificos.DatosCentro.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);
            ...
            cachedSerQNames.add(qName);
            cls = es.redsara.intermediacion.scsp.esquemas.educacion.datosespecificos.DatosTitulacion.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);

           /* qName = new javax.xml.namespace.QName("http://intermediacion.redsara.es/scsp/esquemas/datosespecificos", ">DatosTitular");
            cachedSerQNames.add(qName);
            cls = es.redsara.intermediacion.scsp.esquemas.educacion.datosespecificos.DatosTitular.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);*/
            ...
            cachedSerQNames.add(qName);
            cls = es.redsara.intermediacion.scsp.esquemas.educacion.datosespecificos.DatosTitulo.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);
            ...
            cachedSerQNames.add(qName);
            cls = es.redsara.intermediacion.scsp.esquemas.educacion.datosespecificos.Estado.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);
            ...
            qName = new javax.xml.namespace.QName("http://intermediacion.redsara.es/scsp/esquemas/datosespecificos", ">NombreCarrera");
            cachedSerQNames.add(qName);
            cls = java.lang.String.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(org.apache.axis.encoding.ser.BaseSerializerFactory.createFactory(org.apache.axis.encoding.ser.SimpleSerializerFactory.class, cls, qName));
            ...
            qName = new javax.xml.namespace.QName("http://intermediacion.redsara.es/scsp/esquemas/datosespecificos", ">NumTitulo");
            cachedSerQNames.add(qName);
            cls = java.lang.String.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(org.apache.axis.encoding.ser.BaseSerializerFactory.createFactory(org.apache.axis.encoding.ser.SimpleSerializerFactory.class, cls, qName));
            ...
            cachedSerQNames.add(qName);
            cls = es.redsara.intermediacion.scsp.esquemas.educacion.datosespecificos.Retorno.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);
            
            qName = new javax.xml.namespace.QName("http://intermediacion.redsara.es/scsp/esquemas/datosespecificos", ">RegistroUniv");
            cachedSerQNames.add(qName);
            cls = java.lang.String.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(org.apache.axis.encoding.ser.BaseSerializerFactory.createFactory(org.apache.axis.encoding.ser.SimpleSerializerFactory.class, cls, qName));
            ...
            cachedSerQNames.add(qName);
            cls = es.redsara.intermediacion.scsp.esquemas.educacion.datosespecificos.DatosEspecificos.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);
            //NUEVO
            ...
            cachedSerQNames.add(qName);
            cls = es.redsara.intermediacion.scsp.esquemas.educacion.ws.respuesta.TransmisionesTransmisionDatos.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);
            ...
            cachedSerQNames.add(qName);
            cls = es.redsara.intermediacion.scsp.esquemas.educacion.ws.respuesta.Respuesta.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);
            ...
            cachedSerQNames.add(qName);
            cls = es.redsara.intermediacion.scsp.esquemas.educacion.ws.respuesta.Transmisiones.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);
    ...
    /* (non-Javadoc)
     * @see es.redsara.intermediacion.scsp.esquemas.educacion.ws.Scspws#peticionSincrona(es.redsara.intermediacion.scsp.esquemas.ws.peticion.PeticionSincrona)
     */
    public es.redsara.intermediacion.scsp.esquemas.educacion.ws.respuesta.Respuesta peticionSincrona(es.redsara.intermediacion.scsp.esquemas.ws.peticion.PeticionSincrona peticionSincrona) throws java.rmi.RemoteException {
        if (super.cachedEndpoint == null) {
 ...
 try {        java.lang.Object _resp = _call.invoke(new java.lang.Object[] {peticionSincrona});
		 ...
		 try {
			 ...
			 logger.info("CONSULTA TITULACION UNIVERSITARIA - request: " + llamada);
		 } catch (Exception e) {
			 logger.error("CONSULTA TITULACION UNIVERSITARIA: Error mostrando request: ",e);
		 }
		 ...
		 try {
			 ...
			 logger.info("CONSULTA TITULACION UNIVERSITARIA - response: " + respuesta);
		 } catch (Exception e) {
			 logger.error("CONSULTA TITULACION UNIVERSITARIA: Error mostrando response: ",e);
		 }
        ...
        if (_resp instanceof java.rmi.RemoteException) {
            ...
            try {
                return (es.redsara.intermediacion.scsp.esquemas.educacion.ws.respuesta.Respuesta) _resp;
            } catch (java.lang.Exception _exception) {
                return (es.redsara.intermediacion.scsp.esquemas.educacion.ws.respuesta.Respuesta) org.apache.axis.utils.JavaUtils.convert(_resp, es.redsara.intermediacion.scsp.esquemas.educacion.ws.respuesta.Respuesta.class);
            }
        }
  ...
  throw axisFaultException;
    ...
    /* (non-Javadoc)
     * @see es.redsara.intermediacion.scsp.esquemas.educacion.ws.Scspws#peticionAsincrona(es.redsara.intermediacion.scsp.esquemas.ws.peticion.PeticionAsincrona)
     */
    public es.redsara.intermediacion.scsp.esquemas.ws.confirmacionPeticion.ConfirmacionPeticion peticionAsincrona(es.redsara.intermediacion.scsp.esquemas.ws.peticion.PeticionAsincrona peticionAsincrona) throws java.rmi.RemoteException {
    	...
    	try {
    		String llamada = _call.getMessageContext().getRequestMessage().getSOAPPart().getEnvelope().getBody().toString();
    		logger.info("CONSULTA  TITULACION UNIVERSITARIA ASINCRONA - request: " + llamada);
    	} catch (Exception e) {
    		logger.error("CONSULTA PETICION  TITULACION UNIVERSITARIA ASINCRONA: Error mostrando request: ",e);
    	}
    	// Log de la respuesta soap
    	try {
    		String respuesta = _call.getMessageContext().getResponseMessage().getSOAPPart().getEnvelope().getBody().toString();
    		logger.info("CONFIRMACION PETICION TITULACION UNIVERSITARIA ASINCRONA - response: " + respuesta);
    	} catch (Exception e) {
    		logger.error("CONFIRMACION PETICION TITULACION UNIVERSITARIA ASINCRONA: Error mostrando response: ",e);
    	}
    ...
    /* (non-Javadoc)
     * @see es.redsara.intermediacion.scsp.esquemas.educacion.ws.Scspws#solicitudRespuesta(es.redsara.intermediacion.scsp.esquemas.ws.solicitudRespuesta.SolicitudRespuesta)
     */
    public es.redsara.intermediacion.scsp.esquemas.educacion.ws.respuesta.Respuesta solicitudRespuesta(es.redsara.intermediacion.scsp.esquemas.ws.solicitudRespuesta.SolicitudRespuesta solicitudRespuesta) throws java.rmi.RemoteException {
        if (super.cachedEndpoint == null) {
            throw new org.apache.axis.NoEndPointException();
        }
        org.apache.axis.client.Call _call = createCall();
