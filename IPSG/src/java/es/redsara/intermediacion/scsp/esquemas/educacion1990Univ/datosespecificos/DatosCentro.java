...
public class DatosCentro  implements java.io.Serializable {
    ...
    private java.lang.String codigoUniversidad;

    /** el universidad. */
    private java.lang.String universidad;
     ...
     */
    public DatosCentro(
           java.lang.String codigoUniversidad,
           java.lang.String universidad,
    ...
    /**
     * Gets the codigoUniversidad value for this DatosCentro.
     * 
     * @return codigoUniversidad
     */
    public java.lang.String getCodigoUniversidad() {
        return codigoUniversidad;
    }


    /**
     * Sets the codigoUniversidad value for this DatosCentro.
     *
     * @param codigoUniversidad el nuevo codigo universidad
     */
    public void setCodigoUniversidad(java.lang.String codigoUniversidad) {
        this.codigoUniversidad = codigoUniversidad;
    }


    /**
     * Gets the universidad value for this DatosCentro.
     * 
     * @return universidad
     */
    ...
    /**
     * Sets the universidad value for this DatosCentro.
     *
     * @param universidad el nuevo universidad
     */
    public void setUniversidad(java.lang.String universidad) {
        this.universidad = universidad;
    }
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        ...
        boolean _equals;
        _equals = true && 
            ((this.codigoUniversidad==null && other.getCodigoUniversidad()==null) || 
             (this.codigoUniversidad!=null &&
              this.codigoUniversidad.equals(other.getCodigoUniversidad()))) &&
            ((this.universidad==null && other.getUniversidad()==null) || 
             (this.universidad!=null &&
              this.universidad.equals(other.getUniversidad()))) &&
    ...
    public synchronized int hashCode() {
        ...
        __hashCodeCalc = true;
        int _hashCode = 1;
        if (getCodigoUniversidad() != null) {
            _hashCode += getCodigoUniversidad().hashCode();
        }
        if (getUniversidad() != null) {
            _hashCode += getUniversidad().hashCode();
        }
    ...
    static {
        ...
        elemField.setFieldName("codigoUniversidad");
        elemField.setXmlName(new javax.xml.namespace.QName("http://intermediacion.redsara.es/scsp/esquemas/datosespecificos", "CodigoUniversidad"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://intermediacion.redsara.es/scsp/esquemas/datosespecificos", ">CodigoUniversidad"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("universidad");
        elemField.setXmlName(new javax.xml.namespace.QName("http://intermediacion.redsara.es/scsp/esquemas/datosespecificos", "Universidad"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://intermediacion.redsara.es/scsp/esquemas/datosespecificos", ">Universidad"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
