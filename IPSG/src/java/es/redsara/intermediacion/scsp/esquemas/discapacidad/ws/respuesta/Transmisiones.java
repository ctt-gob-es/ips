...
package es.redsara.intermediacion.scsp.esquemas.discapacidad.ws.respuesta;
...
public class Transmisiones  implements java.io.Serializable {
    ...
    private es.redsara.intermediacion.scsp.esquemas.discapacidad.ws.respuesta.TransmisionesTransmisionDatos[] transmisionDatos;
     ...
     */
    public Transmisiones(
           es.redsara.intermediacion.scsp.esquemas.discapacidad.ws.respuesta.TransmisionesTransmisionDatos[] transmisionDatos) {
     ...
     */
    public es.redsara.intermediacion.scsp.esquemas.discapacidad.ws.respuesta.TransmisionesTransmisionDatos[] getTransmisionDatos() {
        return transmisionDatos;
    }
     ...
     */
    public void setTransmisionDatos(es.redsara.intermediacion.scsp.esquemas.discapacidad.ws.respuesta.TransmisionesTransmisionDatos[] transmisionDatos) {
        this.transmisionDatos = transmisionDatos;
    }
     ...
     */
    public es.redsara.intermediacion.scsp.esquemas.discapacidad.ws.respuesta.TransmisionesTransmisionDatos getTransmisionDatos(int i) {
     ...
     */
    public void setTransmisionDatos(int i, es.redsara.intermediacion.scsp.esquemas.discapacidad.ws.respuesta.TransmisionesTransmisionDatos _value) {
