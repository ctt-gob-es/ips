...
public class ScspwsSoap11Skeleton implements es.redsara.intermediacion.scsp.esquemas.victimasTerrorismo.ws.Scspws, org.apache.axis.wsdl.Skeleton {
    private es.redsara.intermediacion.scsp.esquemas.victimasTerrorismo.ws.Scspws impl;
    ...
    */
    ...
    public ScspwsSoap11Skeleton() {
        this.impl = new es.redsara.intermediacion.scsp.esquemas.victimasTerrorismo.ws.ScspwsSoap11Impl();
    }

    public ScspwsSoap11Skeleton(es.redsara.intermediacion.scsp.esquemas.victimasTerrorismo.ws.Scspws impl) {
        this.impl = impl;
    }
    ...
    {
        es.redsara.intermediacion.scsp.esquemas.victimasTerrorismo.ws.respuesta.Respuesta ret = impl.peticionSincrona(peticionSincrona);
        return ret;
    }
    ...
    {
        es.redsara.intermediacion.scsp.esquemas.victimasTerrorismo.ws.respuesta.Respuesta ret = impl.solicitudRespuesta(solicitudRespuesta);
        return ret;
    }
