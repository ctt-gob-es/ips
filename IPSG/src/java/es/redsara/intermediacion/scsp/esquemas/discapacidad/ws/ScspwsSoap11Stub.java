/**
 * CCAAConsultaDiscapacidadBindingStub.java
 *
 * This file was auto-generated from WSDL
 * by the Apache Axis 1.4 Apr 22, 2006 (06:55:48 PDT) WSDL2Java emitter.
 */

package es.redsara.intermediacion.scsp.esquemas.discapacidad.ws;
 ...
 */
public class ScspwsSoap11Stub extends org.apache.axis.client.Stub implements es.redsara.intermediacion.scsp.esquemas.discapacidad.ws.Scspws {
    ...
    private static void _initOperationDesc1(){
        ...
        oper.setReturnClass(es.redsara.intermediacion.scsp.esquemas.discapacidad.ws.respuesta.Respuesta.class);
   ...
   private void addBindings0() {
       ...
       java.lang.Class documentdf = org.apache.axis.encoding.ser.DocumentDeserializerFactory.class;
            ...
            qName = new javax.xml.namespace.QName("http://intermediacion.redsara.es/scsp/esquemas/datosespecificos", ">>CertificadoDatosDiscapacidad>RespuestaMovilidad");
            cachedSerQNames.add(qName);
            cls = es.redsara.intermediacion.scsp.esquemas.discapacidad.datosespecificos.CertificadoDatosDiscapacidadRespuestaMovilidad.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);

            qName = new javax.xml.namespace.QName("http://intermediacion.redsara.es/scsp/esquemas/datosespecificos", ">>CertificadoDatosDiscapacidad>TiposDiscapacidad");
            cachedSerQNames.add(qName);
            cls = es.redsara.intermediacion.scsp.esquemas.discapacidad.datosespecificos.TipoDiscapacidad[].class;
            cachedSerClasses.add(cls);
            qName = new javax.xml.namespace.QName("http://intermediacion.redsara.es/scsp/esquemas/datosespecificos", "TipoDiscapacidad");
            qName2 = null;
            cachedSerFactories.add(new org.apache.axis.encoding.ser.ArraySerializerFactory(qName, qName2));
            cachedDeserFactories.add(new org.apache.axis.encoding.ser.ArrayDeserializerFactory());

            qName = new javax.xml.namespace.QName("http://intermediacion.redsara.es/scsp/esquemas/datosespecificos", ">CertificadoDatosDiscapacidad");
            cachedSerQNames.add(qName);
            cls = es.redsara.intermediacion.scsp.esquemas.discapacidad.datosespecificos.CertificadoDatosDiscapacidad.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);
            ...
            cachedSerQNames.add(qName);
            cls = es.redsara.intermediacion.scsp.esquemas.discapacidad.datosespecificos.CodigoComunidadAutonoma.class;
            cachedSerClasses.add(cls);
            ...
            cachedSerQNames.add(qName);
            cls = es.redsara.intermediacion.scsp.esquemas.discapacidad.datosespecificos.Consulta.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);
            ...
            cachedSerQNames.add(qName);
            cls = es.redsara.intermediacion.scsp.esquemas.discapacidad.datosespecificos.Estado.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);

            qName = new javax.xml.namespace.QName("http://intermediacion.redsara.es/scsp/esquemas/datosespecificos", ">Expediente");
            cachedSerQNames.add(qName);
            cls = java.lang.String.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(org.apache.axis.encoding.ser.BaseSerializerFactory.createFactory(org.apache.axis.encoding.ser.SimpleSerializerFactory.class, cls, qName));
            ...
            qName = new javax.xml.namespace.QName("http://intermediacion.redsara.es/scsp/esquemas/datosespecificos", ">Factor");
            cachedSerQNames.add(qName);
            cls = es.redsara.intermediacion.scsp.esquemas.discapacidad.datosespecificos.Factor.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(enumsf);
            cachedDeserFactories.add(enumdf);
            ...
            qName = new javax.xml.namespace.QName("http://intermediacion.redsara.es/scsp/esquemas/datosespecificos", ">Puntuacion");
            cachedSerQNames.add(qName);
            ...
            cachedSerQNames.add(qName);
            cls = es.redsara.intermediacion.scsp.esquemas.discapacidad.datosespecificos.Retorno.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);
            ...
            qName = new javax.xml.namespace.QName("http://intermediacion.redsara.es/scsp/esquemas/datosespecificos", ">Codigo2DigitosINE");
            cachedSerQNames.add(qName);
            cls = java.lang.String.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(org.apache.axis.encoding.ser.BaseSerializerFactory.createFactory(org.apache.axis.encoding.ser.SimpleSerializerFactory.class, cls, qName));
            ...
            cachedSerQNames.add(qName);
            cls = es.redsara.intermediacion.scsp.esquemas.discapacidad.datosespecificos.DatosAdicionalesTitular.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);
            ...
            cachedSerQNames.add(qName);
            cls = es.redsara.intermediacion.scsp.esquemas.discapacidad.datosespecificos.DatosEspecificos.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);
            ...
            qName = new javax.xml.namespace.QName("http://intermediacion.redsara.es/scsp/esquemas/datosespecificos", "Grado");
            cachedSerQNames.add(qName);
            cls = int.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(org.apache.axis.encoding.ser.BaseSerializerFactory.createFactory(org.apache.axis.encoding.ser.SimpleSerializerFactory.class, cls, qName));
            ...
            qName = new javax.xml.namespace.QName("http://intermediacion.redsara.es/scsp/esquemas/datosespecificos", ">Resultado");
            cachedSerQNames.add(qName);
            cls = es.redsara.intermediacion.scsp.esquemas.discapacidad.datosespecificos.Resultado.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(enumsf);
            cachedDeserFactories.add(enumdf);
            ...
            cachedSerQNames.add(qName);
            cls = es.redsara.intermediacion.scsp.esquemas.discapacidad.ws.respuesta.TransmisionesTransmisionDatos.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);
            ...
            cachedSerQNames.add(qName);
            cls = es.redsara.intermediacion.scsp.esquemas.discapacidad.ws.respuesta.Respuesta.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);
            ...
            cachedSerQNames.add(qName);
            cls = es.redsara.intermediacion.scsp.esquemas.discapacidad.ws.respuesta.Transmisiones.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);
   ...
   /* (non-Javadoc)
    * @see es.redsara.intermediacion.scsp.esquemas.discapacidad.ws.Scspws#peticionSincrona(es.redsara.intermediacion.scsp.esquemas.ws.peticion.PeticionSincrona)
    */
   public es.redsara.intermediacion.scsp.esquemas.discapacidad.ws.respuesta.Respuesta peticionSincrona(es.redsara.intermediacion.scsp.esquemas.ws.peticion.PeticionSincrona peticionSincrona) throws java.rmi.RemoteException {
       if (super.cachedEndpoint == null) {
...
try {        java.lang.Object _resp = _call.invoke(new java.lang.Object[] {peticionSincrona});
		 ...
		 try {
			 ...
			 logger.info("CONSULTA DISCAPACIDAD - request: " + llamada);
		 } catch (Exception e) {
			 logger.error("CONSULTA DISCAPACIDAD: Error mostrando request: ",e);
		 }
		 ...
		 try {
			 ...
			 logger.info("CONSULTA DISCAPACIDAD - response: " + respuesta);
		 } catch (Exception e) {
			 logger.error("CONSULTA DISCAPACIDAD: Error mostrando response: ",e);
		 }
       ...
       if (_resp instanceof java.rmi.RemoteException) {
           ...
           try {
               return (es.redsara.intermediacion.scsp.esquemas.discapacidad.ws.respuesta.Respuesta) _resp;
           } catch (java.lang.Exception _exception) {
               return (es.redsara.intermediacion.scsp.esquemas.discapacidad.ws.respuesta.Respuesta) org.apache.axis.utils.JavaUtils.convert(_resp, es.redsara.intermediacion.scsp.esquemas.discapacidad.ws.respuesta.Respuesta.class);
           }
       }
 ...
 throw axisFaultException;
   ...
   /* (non-Javadoc)
    * @see es.redsara.intermediacion.scsp.esquemas.discapacidad.ws.Scspws#peticionAsincrona(es.redsara.intermediacion.scsp.esquemas.ws.peticion.PeticionAsincrona)
    */
...
try {        java.lang.Object _resp = _call.invoke(new java.lang.Object[] {peticionAsincrona});
 ...
 throw axisFaultException;
   ...
   /* (non-Javadoc)
    * @see es.redsara.intermediacion.scsp.esquemas.discapacidad.ws.Scspws#solicitudRespuesta(es.redsara.intermediacion.scsp.esquemas.ws.solicitudRespuesta.SolicitudRespuesta)
    */
   public es.redsara.intermediacion.scsp.esquemas.discapacidad.ws.respuesta.Respuesta solicitudRespuesta(es.redsara.intermediacion.scsp.esquemas.ws.solicitudRespuesta.SolicitudRespuesta solicitudRespuesta) throws java.rmi.RemoteException {
       if (super.cachedEndpoint == null) {
           throw new org.apache.axis.NoEndPointException();
       }
       org.apache.axis.client.Call _call = createCall();
