 ...
 */
public class ScspwsProxy implements es.redsara.intermediacion.scsp.esquemas.educacionnouniv.ws.Scspws {
  
  /** el endpoint. */
  private String _endpoint = null;
  
  /** el scspws. */
  private es.redsara.intermediacion.scsp.esquemas.educacionnouniv.ws.Scspws scspws = null;
  ...
  private void _initScspwsProxy() {
    try {
      scspws = (new es.redsara.intermediacion.scsp.esquemas.educacionnouniv.ws.ScspwsServiceLocator()).getscspwsSoap11();
      if (scspws != null) {
        if (_endpoint != null)
   ...
   * @return el scspws
   */
  public es.redsara.intermediacion.scsp.esquemas.educacionnouniv.ws.Scspws getScspws() {
    if (scspws == null)
      _initScspwsProxy();
    return scspws;
  }
