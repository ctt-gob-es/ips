/**
 * PeticionPeriodosV3BindingStub.java
 *
 * This file was auto-generated from WSDL
 * by the Apache Axis 1.4 Apr 22, 2006 (06:55:48 PDT) WSDL2Java emitter.
 */

package es.redsara.intermediacion.scsp.esquemas.victimasTerrorismo.ws;

import org.apache.log4j.Logger;



public class ScspwsSoap11Stub extends org.apache.axis.client.Stub implements es.redsara.intermediacion.scsp.esquemas.victimasTerrorismo.ws.Scspws {
    ...
    private static void _initOperationDesc1(){
        ...
        oper.setReturnClass(es.redsara.intermediacion.scsp.esquemas.victimasTerrorismo.ws.respuesta.Respuesta.class);
    ...
    private void addBindings0() {
        ...
        cachedDeserFactories.add(org.apache.axis.encoding.ser.BaseDeserializerFactory.createFactory(org.apache.axis.encoding.ser.SimpleDeserializerFactory.class, cls, qName));
            ...
            qName = new javax.xml.namespace.QName("http://intermediacion.redsara.es/scsp/esquemas/datosespecificos", ">FXFINAL");
            cachedSerQNames.add(qName);
            cls = java.lang.String.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(org.apache.axis.encoding.ser.BaseSerializerFactory.createFactory(org.apache.axis.encoding.ser.SimpleSerializerFactory.class, cls, qName));
            ...
            qName = new javax.xml.namespace.QName("http://intermediacion.redsara.es/scsp/esquemas/datosespecificos", ">FXINICIO");
            cachedSerQNames.add(qName);
            cls = java.lang.String.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(org.apache.axis.encoding.ser.BaseSerializerFactory.createFactory(org.apache.axis.encoding.ser.SimpleSerializerFactory.class, cls, qName));
            ...
            qName = new javax.xml.namespace.QName("http://intermediacion.redsara.es/scsp/esquemas/datosespecificos", ">IMPBRUTO");
            cachedSerQNames.add(qName);
            cls = java.lang.String.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(org.apache.axis.encoding.ser.BaseSerializerFactory.createFactory(org.apache.axis.encoding.ser.SimpleSerializerFactory.class, cls, qName));
            ...
            qName = new javax.xml.namespace.QName("http://intermediacion.redsara.es/scsp/esquemas/datosespecificos", ">IMPIRPF");
            cachedSerQNames.add(qName);
            cls = java.lang.String.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(org.apache.axis.encoding.ser.BaseSerializerFactory.createFactory(org.apache.axis.encoding.ser.SimpleSerializerFactory.class, cls, qName));
            ...
            qName = new javax.xml.namespace.QName("http://intermediacion.redsara.es/scsp/esquemas/datosespecificos", ">IMPREASS");
            cachedSerQNames.add(qName);
            cls = java.lang.String.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(org.apache.axis.encoding.ser.BaseSerializerFactory.createFactory(org.apache.axis.encoding.ser.SimpleSerializerFactory.class, cls, qName));
            ...
            qName = new javax.xml.namespace.QName("http://intermediacion.redsara.es/scsp/esquemas/datosespecificos", ">IMPSEGSOC");
            cachedSerQNames.add(qName);
            cls = java.lang.String.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(org.apache.axis.encoding.ser.BaseSerializerFactory.createFactory(org.apache.axis.encoding.ser.SimpleSerializerFactory.class, cls, qName));
            ...
            qName = new javax.xml.namespace.QName("http://intermediacion.redsara.es/scsp/esquemas/datosespecificos", ">IPF");
            cachedSerQNames.add(qName);
            cls = java.lang.String.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(org.apache.axis.encoding.ser.BaseSerializerFactory.createFactory(org.apache.axis.encoding.ser.SimpleSerializerFactory.class, cls, qName));
            ...
            cachedSerQNames.add(qName);
            cls = es.redsara.intermediacion.scsp.esquemas.victimasTerrorismo.datosespecificos.DatosEspecificos.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);
            ...
            qName = new javax.xml.namespace.QName("http://intermediacion.redsara.es/scsp/esquemas/ws/peticion", ">CodigoUnidadTramitadora");
            cachedSerQNames.add(qName);
            cls = java.lang.String.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(org.apache.axis.encoding.ser.BaseSerializerFactory.createFactory(org.apache.axis.encoding.ser.SimpleSerializerFactory.class, cls, qName));
            ...
            cachedSerQNames.add(qName);
            cls = es.redsara.intermediacion.scsp.esquemas.victimasTerrorismo.ws.respuesta.TransmisionesTransmisionDatos.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);
            ...
            cachedSerQNames.add(qName);
            cls = es.redsara.intermediacion.scsp.esquemas.victimasTerrorismo.ws.respuesta.Respuesta.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);
            ...
            cachedSerQNames.add(qName);
            cls = es.redsara.intermediacion.scsp.esquemas.victimasTerrorismo.ws.respuesta.Transmisiones.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);
            ...
            qName = new javax.xml.namespace.QName("http://intermediacion.redsara.es/scsp/esquemas/ws/respuesta", ">CodigoUnidadTramitadora");
            cachedSerQNames.add(qName);
            cls = java.lang.String.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(org.apache.axis.encoding.ser.BaseSerializerFactory.createFactory(org.apache.axis.encoding.ser.SimpleSerializerFactory.class, cls, qName));
    ...
    public es.redsara.intermediacion.scsp.esquemas.victimasTerrorismo.ws.respuesta.Respuesta peticionSincrona(es.redsara.intermediacion.scsp.esquemas.ws.peticion.PeticionSincrona peticionSincrona) throws java.rmi.RemoteException {
        if (super.cachedEndpoint == null) {
    ...
    try {        java.lang.Object _resp = _call.invoke(new java.lang.Object[] {peticionSincrona});
    	...
    	// Log de la peticion soap
    	 try {
    		 ...
    		 logger.info("CONSULTA VICTIMAS TERRORISMO - request: " + llamada);
    	 } catch (Exception e) {
    		 logger.error("CONSULTA VICTIMAS TERRORISMO: Error mostrando request: ",e);
    	 }
    	 ...
    	 try {
    		 ...
    		 logger.info("CONSULTA VICTIMAS TERRORISMO - response: " + respuesta);
    	 } catch (Exception e) {
    		 logger.error("CONSULTA VICTIMAS TERRORISMO: Error mostrando response: ",e);
    	 }
        ...
        if (_resp instanceof java.rmi.RemoteException) {
            ...
            try {
                return (es.redsara.intermediacion.scsp.esquemas.victimasTerrorismo.ws.respuesta.Respuesta) _resp;
            } catch (java.lang.Exception _exception) {
                return (es.redsara.intermediacion.scsp.esquemas.victimasTerrorismo.ws.respuesta.Respuesta) org.apache.axis.utils.JavaUtils.convert(_resp, es.redsara.intermediacion.scsp.esquemas.victimasTerrorismo.ws.respuesta.Respuesta.class);
            }
        }
  ...
  //Log de la peticion soap
  	 try {
  		 String llamada = _call.getMessageContext().getRequestMessage().getSOAPPart().getEnvelope().getBody().toString();
  		 logger.info("CONSULTA DATOS VICTIMAS TERRORISMO ASINCRONA - request: " + llamada);
  	 } catch (Exception e) {
  		 logger.error("CONSULTA DATOS VICTIMAS TERRORISMO ASINCRONA: Error mostrando request: ",e);
  	 }
  	 // Log de la respuesta soap
  	 try {
  		 String respuesta = _call.getMessageContext().getResponseMessage().getSOAPPart().getEnvelope().getBody().toString();
  		 logger.info("CONSULTA DATOS VICTIMAS TERRORISMO ASINCRONA - response: " + respuesta);
  	 } catch (Exception e) {
  		 logger.error("CONSULTA DATOS VICTIMAS TERRORISMO ASINCRONA: Error mostrando response: ",e);
  	 }
    ...
    public es.redsara.intermediacion.scsp.esquemas.victimasTerrorismo.ws.respuesta.Respuesta solicitudRespuesta(es.redsara.intermediacion.scsp.esquemas.ws.solicitudRespuesta.SolicitudRespuesta solicitudRespuesta) throws java.rmi.RemoteException {
        if (super.cachedEndpoint == null) {
            throw new org.apache.axis.NoEndPointException();
        }
        org.apache.axis.client.Call _call = createCall();
    ...
    //Log de la peticion soap
 	 try {
 		 String llamada = _call.getMessageContext().getRequestMessage().getSOAPPart().getEnvelope().getBody().toString();
 		 logger.info("RESPUESTA DATOS VICTIMAS TERRORISMO ASINCRONA - request: " + llamada);
 	 } catch (Exception e) {
 		 logger.error("RESPUESTA DATOS VICTIMAS TERRORISMO ASINCRONA: Error mostrando request: ",e);
 	 }
 	 // Log de la respuesta soap
 	 try {
 		 String respuesta = _call.getMessageContext().getResponseMessage().getSOAPPart().getEnvelope().getBody().toString();
 		 logger.info("RESPUESTA DATOS VICTIMAS TERRORISMO ASINCRONA - response: " + respuesta);
 	 } catch (Exception e) {
 		 logger.error("RESPUESTA DATOS VICTIMAS TERRORISMO ASINCRONA: Error mostrando response: ",e);
 	 }
