...
public class DatosTitulacion  implements java.io.Serializable {
    ...
    /** el datos centro. */
    private es.redsara.intermediacion.scsp.esquemas.educacion.datosespecificos.DatosCentro datosCentro;

    /** el datos titulo. */
    /* Datos del título a consultar */
    private es.redsara.intermediacion.scsp.esquemas.educacion.datosespecificos.DatosTitulo datosTitulo;
     ...
     */
    public DatosTitulacion(
           es.redsara.intermediacion.scsp.esquemas.educacion.datosespecificos.DatosCentro datosCentro,
           es.redsara.intermediacion.scsp.esquemas.educacion.datosespecificos.DatosTitulo datosTitulo) {
     ...
     * @return datosCentro
     */
    public es.redsara.intermediacion.scsp.esquemas.educacion.datosespecificos.DatosCentro getDatosCentro() {
        return datosCentro;
    }
     ...
     */
    public void setDatosCentro(es.redsara.intermediacion.scsp.esquemas.educacion.datosespecificos.DatosCentro datosCentro) {
        this.datosCentro = datosCentro;
    }
     ...
     */
    public es.redsara.intermediacion.scsp.esquemas.educacion.datosespecificos.DatosTitulo getDatosTitulo() {
        return datosTitulo;
    }
     ...
     */
    public void setDatosTitulo(es.redsara.intermediacion.scsp.esquemas.educacion.datosespecificos.DatosTitulo datosTitulo) {
        this.datosTitulo = datosTitulo;
    }
