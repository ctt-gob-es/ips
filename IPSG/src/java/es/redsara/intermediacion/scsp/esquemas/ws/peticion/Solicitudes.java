...
public class Solicitudes  implements java.io.Serializable {
    ...
    private es.redsara.intermediacion.scsp.esquemas.ws.peticion.SolicitudTransmision[] solicitudTransmision;
     ...
     */
    public Solicitudes(
           es.redsara.intermediacion.scsp.esquemas.ws.peticion.SolicitudTransmision[] solicitudTransmision) {
     ...
     */
    public es.redsara.intermediacion.scsp.esquemas.ws.peticion.SolicitudTransmision[] getSolicitudTransmision() {
        return solicitudTransmision;
    }
     ...
     */
    public void setSolicitudTransmision(es.redsara.intermediacion.scsp.esquemas.ws.peticion.SolicitudTransmision[] solicitudTransmision) {
        this.solicitudTransmision = solicitudTransmision;
    }
     ...
     */
    public es.redsara.intermediacion.scsp.esquemas.ws.peticion.SolicitudTransmision getSolicitudTransmision(int i) {
     ...
     */
    public void setSolicitudTransmision(int i, es.redsara.intermediacion.scsp.esquemas.ws.peticion.SolicitudTransmision _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://intermediacion.redsara.es/scsp/esquemas/ws/peticion", ">Solicitudes"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("solicitudTransmision");
        elemField.setXmlName(new javax.xml.namespace.QName("http://intermediacion.redsara.es/scsp/esquemas/ws/peticion", "SolicitudTransmision"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://intermediacion.redsara.es/scsp/esquemas/ws/peticion", "SolicitudTransmision"));
