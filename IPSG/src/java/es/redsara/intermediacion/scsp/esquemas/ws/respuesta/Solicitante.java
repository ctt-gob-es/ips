...
public class Solicitante  implements java.io.Serializable {
    ...
    static {
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("http://intermediacion.redsara.es/scsp/esquemas/ws/respuesta", "CodigoUnidadTramitadora"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://intermediacion.redsara.es/scsp/esquemas/ws/respuesta", ">CodigoUnidadTramitadora"));
        elemField.setMinOccurs(0);
