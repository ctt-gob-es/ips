...
public class DatosEspecificos  implements java.io.Serializable {
    ...
    /** el consulta. */
    private es.redsara.intermediacion.scsp.esquemas.educacion1990noUniv.datosespecificos.Consulta consulta;

    /** el retorno. */
    private es.redsara.intermediacion.scsp.esquemas.educacion1990noUniv.datosespecificos.Retorno retorno;
     ...
     */
    public DatosEspecificos(
           es.redsara.intermediacion.scsp.esquemas.educacion1990noUniv.datosespecificos.Consulta consulta,
           es.redsara.intermediacion.scsp.esquemas.educacion1990noUniv.datosespecificos.Retorno retorno,
           java.lang.String id) {
     ...
     * @return consulta
     */
    public es.redsara.intermediacion.scsp.esquemas.educacion1990noUniv.datosespecificos.Consulta getConsulta() {
        return consulta;
    }
     ...
     *
     * @param consulta el nuevo consulta
     */
    public void setConsulta(es.redsara.intermediacion.scsp.esquemas.educacion1990noUniv.datosespecificos.Consulta consulta) {
        this.consulta = consulta;
    }
     ...
     * @return retorno
     */
    public es.redsara.intermediacion.scsp.esquemas.educacion1990noUniv.datosespecificos.Retorno getRetorno() {
        return retorno;
    }
     ...
     */
    public void setRetorno(es.redsara.intermediacion.scsp.esquemas.educacion1990noUniv.datosespecificos.Retorno retorno) {
        this.retorno = retorno;
    }
