...
public class Retorno  implements java.io.Serializable {
    ...
    /** el estado. */
    private es.redsara.intermediacion.scsp.esquemas.educacionnouniv.datosespecificos.Estado estado;

    /** el datos titular. */
    /* Datos del titular del que obtenemos los títulos */
    private es.redsara.intermediacion.scsp.esquemas.educacionnouniv.datosespecificos.RetornoDatosTitular datosTitular;

    /** el lista titulos. */
    private es.redsara.intermediacion.scsp.esquemas.educacionnouniv.datosespecificos.DatosTitulacion[] listaTitulos;
     ...
     */
    public Retorno(
           es.redsara.intermediacion.scsp.esquemas.educacionnouniv.datosespecificos.Estado estado,
           es.redsara.intermediacion.scsp.esquemas.educacionnouniv.datosespecificos.RetornoDatosTitular datosTitular,
           es.redsara.intermediacion.scsp.esquemas.educacionnouniv.datosespecificos.DatosTitulacion[] listaTitulos) {
           this.estado = estado;
     ...
     * @return estado
     */
    public es.redsara.intermediacion.scsp.esquemas.educacionnouniv.datosespecificos.Estado getEstado() {
        return estado;
    }
     ...
     */
    public void setEstado(es.redsara.intermediacion.scsp.esquemas.educacionnouniv.datosespecificos.Estado estado) {
        this.estado = estado;
    }
     ...
     */
    public es.redsara.intermediacion.scsp.esquemas.educacionnouniv.datosespecificos.RetornoDatosTitular getDatosTitular() {
        return datosTitular;
    }
     ...
     */
    public void setDatosTitular(es.redsara.intermediacion.scsp.esquemas.educacionnouniv.datosespecificos.RetornoDatosTitular datosTitular) {
        this.datosTitular = datosTitular;
    }
     ...
     * @return listaTitulos
     */
    public es.redsara.intermediacion.scsp.esquemas.educacionnouniv.datosespecificos.DatosTitulacion[] getListaTitulos() {
        return listaTitulos;
    }
     ...
     */
    public void setListaTitulos(es.redsara.intermediacion.scsp.esquemas.educacionnouniv.datosespecificos.DatosTitulacion[] listaTitulos) {
        this.listaTitulos = listaTitulos;
    }
