...
public class Respuesta  implements java.io.Serializable {
    ...
    /** el transmisiones. */
    private es.redsara.intermediacion.scsp.esquemas.fnumerosa.ws.respuesta.Transmisiones transmisiones;
    ...
    public Respuesta(
           ...
           es.redsara.intermediacion.scsp.esquemas.fnumerosa.ws.respuesta.Transmisiones transmisiones) {
     ...
     */
    public es.redsara.intermediacion.scsp.esquemas.fnumerosa.ws.respuesta.Transmisiones getTransmisiones() {
        return transmisiones;
    }
     ...
     */
    public void setTransmisiones(es.redsara.intermediacion.scsp.esquemas.fnumerosa.ws.respuesta.Transmisiones transmisiones) {
        this.transmisiones = transmisiones;
    }
