...
/**
 * El Class DatosAdicionalesTitular.
 */
public class DatosAdicionalesTitular  implements java.io.Serializable {
    
    /** el fecha nacimiento. */
    private java.lang.String fechaNacimiento;

    /**
     * Crea una nueva datos adicionales titular.
     */
    public DatosAdicionalesTitular() {
    }
    ...
    /**
     * Gets the fechaNacimiento value for this DatosAdicionalesTitular.
     * 
    ...
    /**
     * Sets the fechaNacimiento value for this DatosAdicionalesTitular.
     *
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof DatosAdicionalesTitular)) return false;
        DatosAdicionalesTitular other = (DatosAdicionalesTitular) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(DatosAdicionalesTitular.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://intermediacion.redsara.es/scsp/esquemas/datosespecificos", "DatosAdicionalesTitular"));
