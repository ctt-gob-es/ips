...
public class DatosEspecificos  implements java.io.Serializable {
    ...
    /** el consulta. */
    /* Solo en el mensaje PETICION */
    private es.redsara.intermediacion.scsp.esquemas.fnumerosa.datosespecificos.Consulta consulta;

    /** el retorno. */
    /* Solo en el mensaje RESPUESTA */
    private es.redsara.intermediacion.scsp.esquemas.fnumerosa.datosespecificos.Retorno retorno;
     ...
     */
    public DatosEspecificos(
           es.redsara.intermediacion.scsp.esquemas.fnumerosa.datosespecificos.Consulta consulta,
           es.redsara.intermediacion.scsp.esquemas.fnumerosa.datosespecificos.Retorno retorno,
           java.lang.String id) {
     ...
     * 
     * @return consulta   * Solo en el mensaje PETICION
     */
    public es.redsara.intermediacion.scsp.esquemas.fnumerosa.datosespecificos.Consulta getConsulta() {
        return consulta;
    }
     ...
     * 
     * @param consulta   * Solo en el mensaje PETICION
     */
    public void setConsulta(es.redsara.intermediacion.scsp.esquemas.fnumerosa.datosespecificos.Consulta consulta) {
        this.consulta = consulta;
    }
     ...
     */
    public es.redsara.intermediacion.scsp.esquemas.fnumerosa.datosespecificos.Retorno getRetorno() {
        return retorno;
    }
     ...
     */
    public void setRetorno(es.redsara.intermediacion.scsp.esquemas.fnumerosa.datosespecificos.Retorno retorno) {
        this.retorno = retorno;
    }
