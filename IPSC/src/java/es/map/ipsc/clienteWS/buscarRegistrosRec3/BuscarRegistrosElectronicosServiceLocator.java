 ...
 */
public class BuscarRegistrosElectronicosServiceLocator extends org.apache.axis.client.Service implements es.map.ipsc.clienteWS.buscarRegistrosRec3.BuscarRegistrosElectronicosService {
    ...
    /* (non-Javadoc)
     * @see es.map.ipsc.clienteWS.buscarRegistrosRec3.BuscarRegistrosElectronicosService#getBuscarRegistrosElectronicosServiceAddress()
     */
    ...
    /* (non-Javadoc)
     * @see es.map.ipsc.clienteWS.buscarRegistrosRec3.BuscarRegistrosElectronicosService#getBuscarRegistrosElectronicosService()
     */
    public es.map.ipsc.clienteWS.buscarRegistrosRec3.BuscarRegistrosElectronicos getBuscarRegistrosElectronicosService() throws javax.xml.rpc.ServiceException {
    ...
    /* (non-Javadoc)
     * @see es.map.ipsc.clienteWS.buscarRegistrosRec3.BuscarRegistrosElectronicosService#getBuscarRegistrosElectronicosService(java.net.URL)
     */
    public es.map.ipsc.clienteWS.buscarRegistrosRec3.BuscarRegistrosElectronicos getBuscarRegistrosElectronicosService(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
        	es.map.ipsc.clienteWS.buscarRegistrosRec3.BuscarRegistrosElectronicosServiceSoapBindingStub _stub = new es.map.ipsc.clienteWS.buscarRegistrosRec3.BuscarRegistrosElectronicosServiceSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (es.map.ipsc.clienteWS.buscarRegistrosRec3.BuscarRegistrosElectronicos.class.isAssignableFrom(serviceEndpointInterface)) {
            	es.map.ipsc.clienteWS.buscarRegistrosRec3.BuscarRegistrosElectronicosServiceSoapBindingStub _stub = new es.map.ipsc.clienteWS.buscarRegistrosRec3.BuscarRegistrosElectronicosServiceSoapBindingStub(new java.net.URL(BuscarRegistrosElectronicosService_address), this);
                _stub.setPortName(getBuscarRegistrosElectronicosServiceWSDDServiceName());
                return _stub;
            }
        }
