 ...
 */
public class RegistrarServiceSoapBindingStub extends org.apache.axis.client.Stub implements es.map.ipsc.clienteWS.registrarRec3.RegistrarElectronicosService {
    ...
    private static void _initOperationDesc1(){
        ...
        param = new org.apache.axis.description.ParameterDesc(new javax.xml.namespace.QName("", "registro"), org.apache.axis.description.ParameterDesc.IN, new javax.xml.namespace.QName("http://registrar.ws2.rec2are.map.es", "RegistroType"), es.map.ipsc.clienteWS.registrarRec3.RegistroType.class, false, false);
        oper.addParameter(param);
    ...
    public RegistrarServiceSoapBindingStub(javax.xml.rpc.Service service) throws org.apache.axis.AxisFault {
        ...
        ((org.apache.axis.client.Service)super.service).setTypeMappingVersion("1.2");
            ...
            cls = es.map.ipsc.clienteWS.registroRec3.type.DocumentoType[].class;
            ...
            cachedSerQNames.add(qName);
            cls = es.map.ipsc.clienteWS.registroRec3.type.InteresadoType[].class;
            cachedSerClasses.add(cls);
            ...
            cachedSerQNames.add(qName);
            cls = es.map.ipsc.clienteWS.registrarRec3.RegistroType.class;
            cachedSerClasses.add(cls);
 ...
 try {        java.lang.Object _resp = _call.invoke(new java.lang.Object[] {autenticacion, registro});
 			//para el log de la peticion soap
 			try {
