...
public class OtrosTitulosManagerImpl implements OtrosTitulosManager {
	...
	/* (non-Javadoc)
	 * @see es.map.ipsc.manager.otrosTitulos.OtrosTitulosManager#buscarOtrosTitulosCombo(es.map.ips.model.OtrosTitulosQuery)
	 */
	...
	/* (non-Javadoc)
	 * @see es.map.ipsc.manager.otrosTitulos.OtrosTitulosManager#buscarOtrosTitulosComboVisibilidad(es.map.ips.model.OtrosTitulosQuery)
	 */
	...
	/* (non-Javadoc)
	 * @see es.map.ipsc.manager.otrosTitulos.OtrosTitulosManager#guardarOtrosTitulos(es.map.ipsc.bean.OtrosTitulosBean)
	 */
	...
	/* (non-Javadoc)
	 * @see es.map.ipsc.manager.otrosTitulos.OtrosTitulosManager#modificarOtrosTitulos(es.map.ipsc.bean.OtrosTitulosBean)
	 */
	...
	/* (non-Javadoc)
	 * @see es.map.ipsc.manager.otrosTitulos.OtrosTitulosManager#obtenerOtroTitulo(java.lang.Integer)
	 */
	...
	/* (non-Javadoc)
	 * @see es.map.ipsc.manager.otrosTitulos.OtrosTitulosManager#eliminarOtroTitulo(es.map.ipsc.bean.OtrosTitulosBean)
	 */
	@Override
