...
public class PlantillaPropiosManagerImpl implements PlantillaPropiosManager{
	...
	/* (non-Javadoc)
	 * @see es.map.ipsc.manager.plantilla.PlantillaPropiosManager#buscarPlantillaPropiosAll(es.map.ips.model.PlantillaPropiosQuery)
	 */
	...
	/* (non-Javadoc)
	 * @see es.map.ipsc.manager.plantilla.PlantillaPropiosManager#buscarPlantillaPropios(es.map.ips.model.PlantillaPropiosQuery)
	 */
	public ArrayList<PlantillaPropiosBean> buscarPlantillaPropios(PlantillaPropiosQuery plantillaPropiosQuery) {
		SearchResult<PlantillaPropios> plantillaPropios = plantillaPropiosDAO.search(plantillaPropiosQuery);
	...
	public PlantillaPropiosBean toPlantillaPropiosBeanGestor(PlantillaPropios plantillaPropios){
		...
		//plantillaPropiosBean.setConvocatoriaBean(toConvocatoriaBean()); implementar
	...
	/* (non-Javadoc)
	 * @see es.map.ipsc.manager.plantilla.PlantillaPropiosManager#guardarPlantillaPropios(es.map.ipsc.bean.PlantillaPropiosBean)
	 */
	...
	private CamposPropiosBean toCamposPropiosBean(CamposPropios camposPropios) {					
		...
		auxCamposPropios.setTituloCampoCa(camposPropios.getCampo_ca());
		auxCamposPropios.setTituloCampoGl(camposPropios.getCampo_gl());
		auxCamposPropios.setTituloCampoVl(camposPropios.getCampo_vl());
		auxCamposPropios.setTituloCampoEu(camposPropios.getCampo_eu());
	...
	public PlantillaPropios toPlantillaPropiosNuevoGestor(PlantillaPropiosBean plantillaPropiosBean){
		...
		if(plantillaPropiosBean.getConvocatoriaBean()!=null && !"".equals(plantillaPropiosBean.getConvocatoriaBean())){
			...
			convocatoria.setId(Long.valueOf(plantillaPropiosBean.getConvocatoriaBean().getId()));
	...
	/* (non-Javadoc)
	 * @see es.map.ipsc.manager.plantilla.PlantillaPropiosManager#borrarPlantillasPropios(es.map.ips.model.PlantillaPropiosQuery)
	 */
	...
	public PlantillaPropios toPlantillaPropios(PlantillaPropiosBean plantillaPropiosBean){
		...
		if(plantillaPropiosBean.getConvocatoriaBean()!=null){
			...
			conv.setId(Long.valueOf(plantillaPropiosBean.getConvocatoriaBean().getId()));
	...
	/* (non-Javadoc)
	 * @see es.map.ipsc.manager.plantilla.PlantillaPropiosManager#obtenerPlantillaPropiosById(es.map.ips.model.PlantillaPropiosQuery)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see es.map.ipsc.manager.plantilla.PlantillaPropiosManager#actualizarPlantillaPropios(es.map.ipsc.bean.PlantillaPropiosBean)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see es.map.ipsc.manager.plantilla.PlantillaPropiosManager#obtenerPlantillaPropiosById()
	 */
	@Override
