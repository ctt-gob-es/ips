...
/**
 * El Class DocumentosAnexadosSolicitudTest.
 */
public class DocumentosAnexadosSolicitudTest extends AbstractSpringCommonTestCaseIPSC {
	...
	/** el documentos anexados solicitud spring. */
	private DocumentosAnexadosSolicitudSpring documentosAnexadosSolicitudSpring;
	...
	protected void setUp() throws Exception {
		...
		documentosAnexadosSolicitudSpring = new DocumentosAnexadosSolicitudSpring();
		documentosAnexadosSolicitudSpring.setDocumentosConvocatoriaManager((DocumentosConvocatoriaManager) getBean("documentoConvocatoriasManager"));
		documentosAnexadosSolicitudSpring.setSolicitudManager((SolicitudManager) getBean("solicitudesManager"));
	...
	public void testSearch() {
		...
		try {
			...
			System.out.println("Iniciando test documentosAnexadosSolicitud");
	    	...
	    	SpringForward rtrn = documentosAnexadosSolicitudSpring.execute(mapping, formulario, request, response);
			if (rtrn != null && !StringUtils.isEmpty(rtrn.getPath())) {
				System.out.println("RESULTADO: "+rtrn.getPath());
				if (rtrn.getPath().contains("error")) throw new Exception("Error");
			}
			else throw new Exception("Error");			
			System.out.println("Finalizando test documentosAnexadosSolicitud");
			
		} catch (Exception e) {
			e.printStackTrace(System.out);
			System.out.println("Finalizando test documentosAnexadosSolicitud con errores");
			fail();
		} 
