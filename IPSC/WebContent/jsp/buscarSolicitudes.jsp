...
function SubsanarContinuar(variable){	
	//llamadaSubsanarContinuar(variable);
	llamadaInscribirseContinuar(variable);
}
      ...
      <div class="pae-layout">
        <div class="pae-layout__item pae-u-12/12 pae-u-12/12-lap pae-u-1/1-palm">
          ...
          <%
			...
			if (solicitud.getIdEstadoInscripcion().intValue() == 3 || (solicitud.isSubsanar() && solicitud.getIdEstadoInscripcion().intValue() == 3)) {
...
<%-- 							onclick="<%=enlaceModificarSolicitud%>";" --%>
          ...
          <%
 					...
 					if(solicitud.isSubsanar()) {
 	 					enlaceReanudarSolicitud = "javascript: SubsanarContinuar("+solicitud.getIdConvocatoria()+")";
 					} 
          ...
          <div class="pae-box-details">
            ...
            <div class="pae-box-links__medium-box">
            	<div class="pae-box-buttons">
            <% if(solicitud.isSubsanar()) {  %>
            	<button type="button" class="pae-buttons pae-buttons__2 pae-buttons--default pae-buttons--medium pae-separation" onclick="<%=enlaceReanudarSolicitud%>"><spring:message code="field.incidencias.botonContinuarSub" /></button>
            <% } else { %>
