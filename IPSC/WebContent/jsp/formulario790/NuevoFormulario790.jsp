...
<script type="text/javascript">
  		...
  		function cambiarAutorizar(valor){
  			...
  			document.getElementById("autorizar").value = valor;
  		}
		...
		function cambiarConsentimiento(valor){
  			...
  			if(valor){
  				document.getElementById("motivoOposicion").disabled = false;
  			}else{
  				document.getElementById("motivoOposicion").disabled = true;
  				document.getElementById("motivoOposicion").value = "";
  			}
