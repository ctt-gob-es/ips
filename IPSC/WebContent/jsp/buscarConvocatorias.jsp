                  ...
                  <form:form modelAttribute="buscaConvocatoriasForm" action="/IPSC/secure/buscarConvocatorias" id="formConvocatoriasId" method="post">
                    <fieldset>
                      ...
                      <div class="pae-table__content-form">
                        <form:input path="search" id="search" onchange="cambiarMayusculas(this);" placeholder="Buscar por cuerpo o centro gestor" class="pae-form__input-search" maxlength="50"/>
						            			...
						            			<div class="pae-modal__body pae-modal__body--table">
						            				<!-- inscripcion online f.h -->
						              				<div class="pae-modal__col pae-modal__col--left">
						                				...
						                				<div class="pae-modal__row-content row-content-height">
						                  					...
						                  					<p class="pae-modal__text pae-modal__text--special">
						                  						<spring:message code="field.convocatoria.mensaje5"/>
						                  					</p>
						                  				</div>
						              				...
						              				<div class="pae-modal__col pae-modal__col--right">
						                				...
						                				<div class="pae-modal__row-content pae-pb++">
						                					<h2 class="pae-modal__title pae-modal__title--level2"><spring:message code="field.convocatoria.realiceInscripcion.Presencial"/></h2>
						                  					<p class="pae-modal__text pae-modal__text--special">
						                  						<spring:message code="field.convocatoria.modelo790"/>
						                  					</p>
						                  					<p class="pae-modal__text pae-modal__text--special">
						                  						<span class="pae-modal__text--bold"><spring:message code="field.convocatoria.descargarModelo1"/>
						                  						</span> <spring:message code="field.convocatoria.descargarModelo2"/>
						                  					</p>
	...
	<script type="text/javascript">
	    ...
	    function verMasConvocatorias(){
	    	if(document.getElementById("search").value != "") {
	    		document.getElementById("search_mas").value = document.getElementById("search").value;
	    		document.getElementById("cambios_mas").value="Correcto";
