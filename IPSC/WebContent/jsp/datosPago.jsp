...
function eleccionEntidad(){
    if (document.getElementById("importeOriginal").value == '0.0'){
		...
		<fieldset>
			...
			<div id="formasDePago">
					...
					<div class="pae-layout__item pae-u-6/12 pae-u-8/12-lap pae-u-1/1-palm">
						<div class="pae-form__cell">
							<span class="pae-form__label pae-form__span-label"><spring:message
									code="field.pagoSolicitud.metodoPago" />*</span>
							<div class="pae-form__custom-rb-box">
								...
								<label for="bank-account"class="pae-form__custom-rb-label medium">
									<span class="pae-form__custom-rb-label--text"><spring:message
											code="field.pagoSolicitud.cuentaBancaria" /></span></label> <input
									type="radio" name="checkFormPago" id="credict-card" value="T"
									data-function="fc-advisor-open"
									data-object="advisor-bank-account" class="pae-form__custom-rb"
									onchange="formPagoValue()" /> <label for="credict-card"
									class="pae-form__custom-rb-label medium">
									<span
									class="pae-form__custom-rb-label--text"><spring:message
											code="field.pagoSolicitud.tarjetaCredito" /></span></label>
							</div>
						</div>
					</div>
				</div>
				<div class="pae-layout">
					<div class="pae-layout__item pae-u-4/12 pae-u-8/12-lap pae-u-1/1-palm">
						<div class="pae-form__cell">
							...
							<input type="text" id="nifTitular" name="nifTitular"
								...
								maxlength="9"> <span class="pae-form__text-error">
					...
					<div
						class="pae-layout__item pae-u-4/12 pae-u-8/12-lap pae-u-1/1-palm">
						<div class="pae-form__cell">
							<label for="apellido1Titular" class="pae-form__label"> <span
								class="pae-form__label--text"> <spring:message
										code="field.pagoSolicitud.primerApellido" />*
							</span>
							</label> <input type="text" id="apellido1Titular" name="apellido1Titular"
								class="pae-form__input" style="text-transform: uppercase;"
								maxlength="44" onkeypress="soloLetras(event)"
								onpaste="comprobarPasteCaracteresEspeciales(this);"> <span
								class="pae-form__text-error"> <spring:message
					...
					<div
						class="pae-layout__item pae-u-4/12 pae-u-8/12-lap pae-u-1/1-palm">
						<div class="pae-form__cell">
							<label for="apellido2Titular" class="pae-form__label"> <span
								class="pae-form__label--text"> <spring:message
										code="field.pagoSolicitud.segundoApellido" />*
							</span>
							</label> <input type="text" id="apellido2Titular" name="apellido2Titular"
								class="pae-form__input" style="text-transform: uppercase;"
				...
				<div class="pae-layout">
					<div class="pae-layout__item pae-u-1/1 pae-u-1/1-lap pae-u-1/1-palm">
						<div id="advisor-bank-account" class="pae-form__cell">
							<div class="pae-form__advisor-tooltip pae-form__advisor-tooltip--no-arrow pae-form__advisor-tooltip--no-shadow pae-form__advisor-tooltip--big">
								...
								<button name="advisorclose" id="advisorclose" data-function="fc-advisor-close"
									class="pae-form__advisor-close">
								</button>
							</div>
						</div>
					</div>
					...
					<div id="avisoHora" class="pae-form__cell pae-hidden">
						<div class="pae-form__advisor-tooltip pae-form__advisor-tooltip--no-arrow pae-form__advisor-tooltip--no-shadow pae-form__advisor-tooltip--big">
							...
							<button name="advisorclose" id="advisorclose"
								data-function="fc-advisor-close"
								class="pae-form__advisor-close">
							</button>
						</div>
					</div>
				...
				<div class="pae-layout">
					<div class="pae-layout__item pae-u-4/12 pae-u-8/12-lap pae-u-1/1-palm">
					<div class="pae-form__cell">
						<span class="pae-form__span-button"> 
							<label	for="entidadAdeudo" class="pae-form__label">
								<span class="pae-form__label pae-form__label--text">
								<spring:message	code="field.pagoSolicitud.entidad" />*</span>
							</label>
							<button type="button" id="bank-help" name="bank-help"
								data-function="fc-help-bank"
								class="pae-form__span-button--button-help">
							</button>
						</span>
						<div id="divTarjeta">
							...
							<span class="pae-form__text-error"><spring:message
								...
								id="errorHorariosTarjeta" class="pae-form__text-error"><spring:message
				...
				<div
					...
					<div data-opcion="tarjeta" class="pae-form__cell pae-hidden">
						<label for="numeroTarjetaHTML" class="pae-form__label">
							<span class="pae-form__label pae-form__label--text">
								<spring:message code="field.pagoSolicitud.numTarjetaAux" />*
							</span>
						</label> 
						<input
					...
					<div data-opcion="cuenta" class="pae-form__cell">
				...
				<div class="pae-layout__item pae-u-3/12 pae-u-4/12-lap pae-u-1/1-palm">
					<div data-opcion="tarjeta" class="pae-form__cell pae-hidden">
						...
						</select><span id="mesTarjetaSpan" class="pae-form__text-error"><spring:message
								code="field.pagoSolicitud.fechaTarjetaError" /></span>
						<jsp:useBean id="now" class="java.util.Date" scope="request" />
						<fmt:formatDate value="${now}" pattern="y" var="currentYear" />
						<select id="caducidadTarjeta2" name="caducidadTarjeta2"	data-function="function-selectize" 
							data-placeholder="yyyy"	class="pae-form__select pae-form__select--small large">
							<option value="" class="pae-form__option">yyyy</option>
							<c:forEach var="i" begin="0" end="10">
								<option value="${currentYear+i}" class="pae-form__option">
