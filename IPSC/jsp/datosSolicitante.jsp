				...
				<div class="pae-layout__item pae-u-2/12 pae-u-2/12-lap pae-u-1/1-palm">
					<div class="pae-form__cell">
						...
						<span class="pae-form__text-readonly">
							<input type="text" onkeyup="cargaPistola(${idConvocatoria}, event)" id="numJustInput" name="numJustificantePresencial" value="" style="text-transform: uppercase;width: 121%;" class="pae-form__input">
							<!-- input que oculta la ristra de caracteres que genera la pistola en la lectura -->
							<input type="text" id="numJustInputHide" value="" style="text-transform: uppercase;width: 121%;display:none;" class="pae-form__input" disabled>
						</span>
					</div>
				</div>
				...
				<div class="pae-layout">
					<div class="pae-layout__item pae-u-2/12 pae-u-2/12-lap pae-u-1/1-palm">
						<div class="pae-form__cell">
							...
							<logic:equal name="ciudadanoBean" property="tipoPersona" value="FH">
								<input type="text" maxlength="9" id="nifCiudadano" name="nifCiudadano" value="" style="text-transform: uppercase;" class="pae-form__input" />
							</logic:equal>
							</span>
						</div>
					</div>
					<div class="pae-layout__item pae-u-3/12 pae-u-3/12-lap pae-u-1/1-palm">
						<div class="pae-form__cell">
							...
							<logic:equal name="ciudadanoBean" property="tipoPersona" value="FH">
								<input type="text"  maxlength="44" id="primerApellido" name="primerApellido" value="" style="text-transform: uppercase;" 
					...
					<div class="pae-layout__item pae-u-3/12 pae-u-3/12-lap pae-u-1/1-palm">
						...
						<logic:equal name="ciudadanoBean" property="tipoPersona" value="FH">
							<input type="text"  maxlength="46" id="segundoApellido" name="segundoApellido" value="" style="text-transform: uppercase;" 
								class="pae-form__input" onkeypress="soloLetras(event)" onpaste="comprobarPasteCaracteresEspeciales(this);"/>
						</logic:equal>
							</span>
						</div>
					...
					<div class="pae-layout__item pae-u-3/12 pae-u-3/12-lap pae-u-1/1-palm">
						...
						<logic:equal name="ciudadanoBean" property="tipoPersona" value="FH">
							<input type="text"  maxlength="38" id="nombre" name="nombre"  value="" style="text-transform: uppercase;" 
								class="pae-form__input" onkeypress="soloLetras(event)" onpaste="comprobarPasteCaracteresEspeciales(this);"/>
						</logic:equal>
							</span>
						</div>
					...
					<div class="pae-layout__item pae-u-3/12 pae-u-4/12-lap pae-u-2/3-palm">
						<div class="pae-form__cell">
							...
							<div class="pae-form__box-datepicker">
								<c:if test="${empty altaSolicitud.fechaNacimiento}">
								...
								<c:if test="${not empty altaSolicitud.fechaNacimiento}">
								<input type="text" id="fechaNacimiento" onchange="return validaFechaFormato(document.getElementById('fechaNacimiento'))"
									name="fechaNacimiento" data-function="function-datepicker" readOnly="true"
									placeholder="dd/mm/aaaa" value="${altaSolicitud.fechaNacimiento}" class="pae-form__input">									
								</c:if>
							</div>
						...
						<div class="pae-form__cell">
							<div class="control-group">
								...
								<input type="text" name="nacionalidad" id="nacionalidad"
									...
									class="pae-form__input" property="nacionalidad" maxlength="25" onpaste="comprobarPasteCaracteresEspeciales(this);"/>
				...
				<div class="pae-layout">
					<div class="pae-layout__item pae-u-4/12 pae-u-4/12-lap pae-u-1/1-palm">
						<div class="pae-form__cell">
							...
							<input type="text" id="email" name="email" value="" class="pae-form__input" property="mail" maxlength="50">
							<span class="pae-form__text-error">
					...
					<div class="pae-layout__item pae-u-7/12 pae-u-7/12-lap pae-u-1/1-palm">
						<div class="pae-form__cell">
							...
							<input type="text" id="calleDomicilio" style="text-transform: uppercase;"
								name="calleDomicilio" property="calleDomicilio" value="" class="pae-form__input" maxlength="120">
							<span class="pae-form__text-error">
					...
					<div class="pae-layout__item pae-u-5/12 pae-u-5/12-lap pae-u-1/3-palm">
						<div class="pae-form__cell">
							...
							<input type="text" id="codigoPostalDomicilio" name="codigoPostalDomicilio"
								property="codigoPostalDomicilio" value="" class="pae-form__input pae-form__input--small  w45"
					...
					<div class="pae-layout__item pae-u-4/12 pae-u-6/12-lap pae-u-2/3-palm">
						<div class="pae-form__cell">
							...
							<input type="text" id="municipioDomicilio" style="text-transform: uppercase;" name="municipioDomicilio"
								property="municipioDomicilio" value="" class="pae-form__input" maxlength="50" onpaste="comprobarPasteCaracteresEspeciales(this);">
							<span class="pae-form__text-error">
								<spring:message code="field.solicitud.campoObligatorio" />
							</span>
						</div>
