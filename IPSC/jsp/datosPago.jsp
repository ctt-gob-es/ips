                ...
                <fieldset>
                  ...
                  <div class="pae-layout">
				  	<div class="pae-layout__item pae-u-4/12 pae-u-8/12-lap pae-u-1/1-palm">
            			<div class="pae-form__cell">
               				<label for="nifTitular" class="pae-form__label">
             		...
             		<div class="pae-layout__item pae-u-4/12 pae-u-8/12-lap pae-u-1/1-palm">
            			<div class="pae-form__cell">
               				<label for="nombreTitular" class="pae-form__label">
               					<span class="pae-form__label--text">
             		...
             		<div class="pae-layout__item pae-u-4/12 pae-u-8/12-lap pae-u-1/1-palm">
            			<div class="pae-form__cell">
               				<label for="apellido1Titular" class="pae-form__label" >
               					<span class="pae-form__label--text">
             		...
             		<div class="pae-layout__item pae-u-4/12 pae-u-8/12-lap pae-u-1/1-palm">
            			<div class="pae-form__cell">
               				<label for="apellido2Titular" class="pae-form__label">
               					<span class="pae-form__label--text">
                  ...
                  <div class="pae-layout">
                    ...
                    <div class="pae-layout__item pae-u-3/12 pae-u-4/12-lap pae-u-1/1-palm">
                      <div data-opcion="tarjeta" class="pae-form__cell">
                        ...
                        <fmt:formatDate value="${now}" pattern="y" var="currentYear"/>
                        <select id="caducidadTarjeta2" name="caducidadTarjeta2" data-function="function-selectize" data-placeholder="yyyy" class="pae-form__select pae-form__select--small large">
                          ...
                          <c:forEach var = "i" begin = "0" end = "10">
					         <option value="${currentYear+i}" class="pae-form__option"><c:out value="${currentYear+i}" /></option>
					      </c:forEach>                    
...
$( document ).ready(function() {
    document.getElementById("importeHTML").textContent = document.getElementById("importeOriginal").value - document.getElementById("importePagado").value;
    if (document.getElementById("importeOriginal").value == 0){
    	document.getElementById("formasDePago").className += "pae-hidden";
    	document.getElementById("formPago").value = "N";
    }
});
</script>