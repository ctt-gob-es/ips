...
<div id="content_tituloNivel1">
     ...
     <spring:message code="field.titulo.informacionFnumerosa"/></div>
</div>
<br>
<div class="clear"/>
<div style="width: 98%;">
	<spring:message code="field.informacion.fnumerosa1"/><a target="_blank" href="<%=request.getContextPath()%>/secure/tablaComunidades">http://administracion.gob.es/PAG/PID</a><br><br> 
	<spring:message code="field.informacion.fnumerosa2"/>
</div>
