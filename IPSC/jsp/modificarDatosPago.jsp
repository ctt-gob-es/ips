	...
	if(pagoInicialModif == "S"){
		if(formPago == null || formPago == ""){
			...
			if(formPago == "E"){
				...
				if(document.getElementById("comunidadesFNExento").className == "pae-layout__item pae-u-6/12 pae-u-6/12-lap pae-u-1/1-palm"){
				...
				/* if(document.getElementById("IBANInput").value == "" || document.getElementById("IBANInput").value == null || document.getElementById("IBANInput").value.length != 28) {
					document.getElementById("IBANInput").className += " pae-form__input--error";
					if($("#setFocus").val() == "")
						$("#setFocus").val('IBANInput');
					error = 1;
              ...
              <div class="pae-box__body">
                ...
                <fieldset id="importeAPagar" style="display:none;">
                  ...
                  <div class="pae-layout">
                    <div class="pae-layout__item pae-u-4/12 pae-u-5/12-lap pae-u-1/1-palm">
                      <div class="pae-form__cell">
                        ...
                        <div class="pae-form__dark-cell"><span class="pae-form__dark-cell-text"><spring:message code="field.pagoSolicitud.importeAPagar" /></span>
                        	...
                        	<strong class="pae-form__dark-cell-text pae-form__dark-cell-text--big pae-form__dark-cell-text--bold pae-form__dark-cell-text--spacing" 
                        		id="importeHTML" name="importeHTML"><%=importe%></strong> &euro;</span></div>
                      </div>
                    </div>
                  </div>
                  ...
                  <logic:equal name="ciudadanoBean" property="tipoPersona" value="FH">
                  	<div class="pae-layout">
                  		<div class="pae-layout__item pae-u-4/12 pae-u-5/12-lap pae-u-1/1-palm" style="margin-top:-1px">
                  			<div  class="pae-form__cell">
								<label for="nrcCiudadano" class="pae-form__label"><span class="pae-form__label pae-form__label--text"><spring:message code="field.pagoSolicitud.NRC"/></span></label>
								<input type="text" size="22" maxlength="22" id="nrcCiudadano" name="nrcCiudadano" style="text-transform: uppercase;" class="pae-form__input">
								<span class="pae-form__text-error"><spring:message code="field.solicitud.NrcObligatorio"/></span>
							</div>
						</div>
	  				</div>
                  </logic:equal>
                    ...
                    <div class="pae-layout__item pae-u-6/12 pae-u-8/12-lap pae-u-1/1-palm">
                      <div class="pae-form__cell"><span class="pae-form__label pae-form__span-label"><spring:message code="field.pagoSolicitud.metodoPago" />*</span>
                        <div class="pae-form__custom-rb-box">
                          <input type="radio" name="checkFormPago" id="credict-card" value="T" checked="checked" data-function="fc-advisor-open" data-object="advisor-bank-account" class="pae-form__custom-rb" onchange="formPagoValue()"/>
                          <label for="credict-card" class="pae-form__custom-rb-label medium"><span class="pae-form__custom-rb-label--text"><spring:message code="field.pagoSolicitud.tarjetaCredito" /></span></label>
                          <input type="radio" name="checkFormPago" id="bank-account" value="C" data-function="fc-advisor-open" data-object="advisor-bank-account" class="pae-form__custom-rb" onchange="formPagoValue()"/>
                  ...
                  <div class="pae-layout">
				  	<div class="pae-layout__item pae-u-4/12 pae-u-8/12-lap pae-u-1/1-palm">
            			<div class="pae-form__cell">
             				...
             				<input type="text" id="nifTitular" name="nifTitular" class="pae-form__input" style="text-transform: uppercase;" onpaste="comprobarPasteCaracteresEspeciales(this);" maxlength="9">
             		...
             		<div class="pae-layout__item pae-u-4/12 pae-u-8/12-lap pae-u-1/1-palm">
            			<div class="pae-form__cell">
             				...
             				<input type="text" id="nombreTitular" name="nombreTitular" class="pae-form__input" style="text-transform: uppercase;" onpaste="comprobarPasteCaracteresEspeciales(this);" onkeypress="soloLetras(event)" maxlength="38">
                			<span class="pae-form__text-error">
             		...
             		<div class="pae-layout__item pae-u-4/12 pae-u-8/12-lap pae-u-1/1-palm">
            			<div class="pae-form__cell">
             				...
             				<input type="text" id="apellido1Titular" name="apellido1Titular" class="pae-form__input" style="text-transform: uppercase;" maxlength="44" onkeypress="soloLetras(event)" onpaste="comprobarPasteCaracteresEspeciales(this);">
                			<span class="pae-form__text-error">
								<spring:message code="field.solicitud.campoObligatorio" />
							</span>
                 		</div>	
             		...
             		<div class="pae-layout__item pae-u-4/12 pae-u-8/12-lap pae-u-1/1-palm">
            			<div class="pae-form__cell">
             				...
             				<input type="text" id="apellido2Titular" name="apellido2Titular" class="pae-form__input" style="text-transform: uppercase;" maxlength="46" onkeypress="soloLetras(event)" onpaste="comprobarPasteCaracteresEspeciales(this);">
                			<span class="pae-form__text-error">
								<spring:message code="field.solicitud.campoObligatorio" />
							</span>
                 		</div>	
                  ...
                  <div class="pae-layout">
                    <div class="pae-layout__item pae-u-4/12 pae-u-8/12-lap pae-u-1/1-palm">
                      <div class="pae-form__cell"><span class="pae-form__span-button">
                          <label for="entidadAdeudo" class="pae-form__label"><span class="pae-form__label pae-form__label--text"><spring:message code="field.pagoSolicitud.entidad" />*</span></label>
                          <button type="button" id="bank-help" name="bank-help" data-function="fc-help-bank" class="pae-form__span-button--button-help"></button></span>
                    	  <div id="divTarjeta">
					      	<form:select path="entidadTarjeta" id="entidadTarjeta" onchange="actualizarEntidadTarjeta(this.value)" class="pae-form__input large">
  								<option value="0" selected="selected" class="pae-form__option"><spring:message code="field.solicitud.selecciona"/></option>
  						...
  						<div id="divAdeudo" class="pae-hidden">	
  							<form:select path="entidadAdeudo" id="entidadAdeudo" onchange="actualizarEntidadAdeudo(this.value)" class="pae-form__input large">
								<option value="0" selected="selected" class="pae-form__option"><spring:message code="field.solicitud.selecciona"/></option>
								<form:options items="${entidades}" itemLabel="descripcion" itemValue="codigo" style="text-transform: uppercase;" />	
  							</form:select>
  							<span class="pae-form__text-error"><spring:message
										code="field.solicitud.campoObligatorio" /></span>
  						</div>
                        ...
                        <div id="help-bank-tooltip" class="pae-form__help-tooltip"> 
                          <p class="pae-form__help-tooltip-text"><spring:message code="field.pagoSolicitud.infoEntidad"/><strong class="pae-form__help-tooltip-text--bold"><spring:message code="field.pagoSolicitud.infoEntidad2"/></strong>
                          </p>
                        </div>
                      </div>
                    </div>
                    <div class="pae-layout__item pae-u-4/12 pae-u-4/12-lap pae-u-1/1-palm">
                      <div data-opcion="tarjeta" class="pae-form__cell">
                        <label for="numeroTarjetaHTML" class="pae-form__label"><span class="pae-form__label pae-form__label--text"><spring:message code="field.pagoSolicitud.numTarjetaAux" />*</span></label>
                        <input type="text" id="numeroTarjetaHTML" name="numeroTarjetaHTML" placeholder="0000-0000-0000-0000" value="" class="pae-form__input"  maxlength="19"
                        	  onkeypress="return soloNumeros(event);" onkeyup="escribirGuionTarjeta(this.value, event);"><span id="tarjetaSpan" class="pae-form__text-error"><spring:message code="field.pagoSolicitud.numTarjetaExacto" /></span>
                      </div>
                      <div data-opcion="cuenta" class="pae-form__cell pae-hidden">
                        ...
                        <input type="text" id="IBANInput" name="IBANInput" placeholder="ES00-0000-0000-00-000000000"  maxlength="28" value="ES"
                    ...
                    <div class="pae-layout__item pae-u-3/12 pae-u-4/12-lap pae-u-1/1-palm">
                      <div data-opcion="tarjeta" class="pae-form__cell">
                        <label for="FechaCaducidad" class="pae-form__label"><span class="pae-form__label pae-form__label--text"><spring:message code="field.pagoSolicitud.fechaCaducidadTarjetaAux" />*</span></label>
                        <select id="caducidadTarjeta1" name="caducidadTarjeta1" data-function="function-selectize" data-placeholder="mm" class="pae-form__select pae-form__select--small large">
                        ...
                        </select><span id="mesTarjetaSpan" class="pae-form__text-error"><spring:message code="field.pagoSolicitud.fechaTarjetaError" /></span>
                        <select id="caducidadTarjeta2" name="caducidadTarjeta2" data-function="function-selectize" data-placeholder="yyyy" class="pae-form__select pae-form__select--small large">
                        ...
                        </select><span id="anoTarjetaSpan" class="pae-form__text-error"><spring:message code="field.pagoSolicitud.fechaTarjetaError" /></span>
                      </div>
                    </div>
                  </div>
                  </div>
                ...
                <div id="mensajePagoModificado" style="display:none;">
                	La inscripción se pagó aplicando el descuento correspondiente al motivo que solicitó. En caso de haberlo solicitado por error y le corresponda un motivo con mayor descuento deberá acudir a un centro gestor para realizar su subsanación.
                </div>
                ...
                <c:if test="${importePagado ne '0.0' }">       
                 <fieldset id="importePagado2">
                  ...
                  <div class="pae-layout">
                    <div class="pae-layout__item pae-u-4/12 pae-u-5/12-lap pae-u-1/1-palm">
                      <div class="pae-form__cell">
                        <label class="pae-form__label--text hiddenAccesible"><spring:message code="field.pagoSolicitud.importePagado" /></label>
                        <div class="pae-form__dark-cell"><span class="pae-form__dark-cell-text"><spring:message code="field.pagoSolicitud.importePagado" /></span>
                        	<span id=""class="pae-form__dark-cell-text pae-form__dark-cell-text--big">
                        	<strong class="pae-form__dark-cell-text pae-form__dark-cell-text--big pae-form__dark-cell-text--bold pae-form__dark-cell-text--spacing" 
                        		>${altaSolicitud.importePagado}</strong> &euro;</span></div>
                      </div>
                    </div>
                  </div>
                  </fieldset>
