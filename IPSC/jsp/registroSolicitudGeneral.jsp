...
<script type="text/javascript">
	...
	function eliminarVariosDocumentos(select) {
		var x = document.getElementsByName("file"+select).length;
		var limit2 = limit+1;
	...
	<input type="hidden" id="stopFileUpload" value="false" />
 	<input type="hidden" id="htmlFormulario"/>
		...
		%>
			...
			<form:input path="<%=nameExtractoFirefox%>" class="text_Largo" maxlength="100"  id="<%=nameExtractoFirefox%>" />
			<form:input path="<%=nameTipoDoc%>" class="text_Largo" maxlength="100"  id="<%=nameTipoDoc%>" />
			<form:input path="<%=tipoDocumento%>" class="text_Largo" maxlength="100"  id="<%=tipoDocumento%>" />
			<form:input path="<%=nameDocFile%>" class="text_Largo" maxlength="100"  id="<%=nameDocFile%>" />
			<form:textarea path="<%=docFic%>" cols="80" rows="3" id="<%=docFic%>" /> <br />
