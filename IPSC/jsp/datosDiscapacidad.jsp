                  ...
                  <div class="pae-layout">
                    <div class="pae-layout__item pae-u-2/12 pae-u-2/12-lap pae-u-1/3-palm">
                      <div class="pae-form__cell">
                        ...
                        <input type="text" name="porcentajeDiscapacidad" id="porcentajeDiscapacidad" onchange="calcularImporte2();desmarcarChecks();"  maxlength="3" value="" onkeypress="return soloNumeros(event);" onpaste="comprobarPasteCaracteresNumericos(this);"
...
<span class="obligatorio" id="oblComunidadDDExento" style="display: none;">*</span>
	                        </span>
                        </label>
